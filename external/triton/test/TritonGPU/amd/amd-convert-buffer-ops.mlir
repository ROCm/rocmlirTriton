...
// RUN: triton-opt %s -split-input-file --tritonamdgpu-convert-buffer-ops="gfx-arch=gfx1100 analyze-small-tensor-ofst=true"| FileCheck %s --check-prefixes=FMINMAX,FMINMAX-F32,FMINMAX-NO-F64,IMINMAX
// RUN: triton-opt %s -split-input-file --tritonamdgpu-convert-buffer-ops="gfx-arch=gfx1170 analyze-small-tensor-ofst=true"| FileCheck %s --check-prefixes=FMINMAX,FMINMAX-F32,FMINMAX-NO-F64,IMINMAX
