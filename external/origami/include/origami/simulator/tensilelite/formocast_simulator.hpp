 ...
 public:
  ...
  struct MemoryAccessCosts {
    ...
    bool operator==(MemoryAccessCosts const& rhs) const {
      return std::tie(mem_l1_req,
                      ...
                      MT_B_L1_req,
                      MT_A_L2_req,
                      MT_B_L2_req) == std::tie(rhs.mem_l1_req,
                                               rhs.mem_l2_req,
                                               rhs.mem_l3_req,
                                               rhs.mem_hbm_req,
                                               rhs.l1_hit,
  ...
  struct HardwareConstants {
    ...
    void print() const {
      ...
      std::cout << "  architecture:         "
                << (architecture == hardware_t::architecture_t::gfx950    ? "gfx950"
                    : architecture == hardware_t::architecture_t::gfx942  ? "gfx942"
                    : architecture == hardware_t::architecture_t::gfx1201 ? "gfx1201"
                                                                          : "Unknown")
                << std::endl;
      ...
      std::cout << "  LocalReadConflictMultiplierB128: " << LocalReadConflictMultiplierB128
                << std::endl;
      std::cout << "  LocalReadConflictMultiplierB64: " << LocalReadConflictMultiplierB64
                << std::endl;
  ...
  struct TieBreakerInfo {
    ...
    bool operator==(TieBreakerInfo const& rhs) const {
      return std::tie(
                 memory, perf, preloop, loop, tail, store, gsu, lsu, math, mt0, mt1, du, svw) ==
             std::tie(rhs.memory,
                      rhs.perf,
                      rhs.preloop,
                      rhs.loop,
   ...
   */
  double calculateGlobalSplitUOverhead(double M,
                                       double N,
                                       double K,
                                       double NumBatches,
                                       double GlobalSplitU,
   ...
   */
  double calculateLocalSplitUOverhead(double MT0,
                                      double MT1,
                                      double lsu,
                                      uint32_t svw,
                                      uint32_t numThreads,
   ...
   */
  MemoryAccessCosts calculateMTMemoryAccessCosts(double M,
                                                 double N,
                                                 double K_AfterGSU,
                                                 double MT0,
                                                 double MT1,
   ...
   */
  double getLoop_time(MemoryAccessCosts& mem,
                      double math,
                      uint32_t loopCnt,
                      double pgr,
                      uint32_t num_tiles,
   ...
   */
  L1CacheHitRate computeL1CacheHitRate(const HardwareConstants& hw,
                                       double MT0,
                                       double MT1,
                                       uint32_t depthU,
                                       uint32_t bpeA,
   ...
   */
  double resolveOccupancy(const HardwareConstants& hw,
                          double perf,
                          double prefetch,
                          double mathCost,
                          double storeCost,
   ...
   */
  int getLocalWriteQueueFullStallCycles(int currentCycle,
                                        int previousLW,
                                        int issueCycles,
                                        int bpWrite,
                                        int numWaves) const;
   ...
   */
  void pushLocalReadWrite(int currentCycle,
                          std::queue<int>& fifo,
                          int bpr,
                          double bankConflict,
                          bool isLocalRead,
 ...
 */
ORIGAMI_EXPORT bool compareConfigTieBreaker(double M,
                                            double N,
                                            double K,
                                            size_t batch,
                                            double mt0_a,
