...
inline double getL2LoadRequest(double L1_req, double L1_hit, double tcc_ea0_coalsced) {
  return L1_req * (1 - L1_hit) / (tcc_ea0_coalsced >= 1 ? 1 : 2);
}

inline double getL3LoadRequest(double L2_req, double L2_hit, double tcc_ea0_coalsced) {
  return L2_req * (1 - L2_hit) / std::ceil(tcc_ea0_coalsced);
}

inline double getHBMLoadRequest(double L3_req, double L3_hit) { return L3_req * (1 - L3_hit); }
 ...
 */
ORIGAMI_EXPORT double getMultipleBufferOverhead(double M,
                                                double N,
                                                double GlobalSplitU,
                                                double NumBatches,
                                                uint32_t bpeCompute,
 ...
 */
ORIGAMI_EXPORT double getMultipleBufferSingleKernelOverhead(double GlobalSplitU,
                                                            double MT0,
                                                            double MT1,
                                                            uint32_t bpeCompute,
                                                            double NumCUs,
 ...
 */
ORIGAMI_EXPORT double getLocalSplitKOverhead(double MT0,
                                             double MT1,
                                             double lsu,
                                             uint32_t svw,
                                             uint32_t numThreads,
 ...
 */
ORIGAMI_EXPORT L1CacheHitRate computeL1CacheHitRate(double L1CacheCapacity,
                                                    double L1CacheLineSize,
                                                    double L1BusWidthPerCU,
                                                    double MT0,
                                                    double MT1,
 ...
 */
ORIGAMI_EXPORT L3CacheHitRate computeL3CacheHitRate(double M,
                                                    double N,
                                                    double K,
 ...
 */
ORIGAMI_EXPORT L2CacheHitRate computeL2CacheHitRate(uint32_t M,
                                                    uint32_t N,
                                                    uint32_t K,
                                                    uint32_t MT0,
                                                    uint32_t MT1,
 ...
 */
ORIGAMI_EXPORT double calculateStoreL3Request(double M,
                                              double N,
                                              double MT0,
                                              double MT1,
                                              double& non_edge_req,
 ...
 */
ORIGAMI_EXPORT double calculateStoreL2Request(double M,
                                              double N,
                                              double MT0,
                                              double MT1,
                                              double SVW,
 ...
 */
ORIGAMI_EXPORT double calculateStoreL1Request(double M,
                                              double N,
                                              double MT0,
                                              double MT1,
                                              double SVW,
 ...
 */
ORIGAMI_EXPORT int getGlobalReadQueueFullStallCycles(int currentCycle,
                                                     std::deque<int>& fifo,
                                                     int bpRead,
                                                     int numWaves,
                                                     bool isStall,
 ...
 * @return Stall cycles if FIFO is full, currentCycle otherwise
 */
ORIGAMI_EXPORT int getLocalReadQueueFullStallCycles(int currentCycle,
                                                    std::queue<int>& fifo,
                                                    int bpRead,
                                                    int numWaves,
 ...
 */
ORIGAMI_EXPORT int getLocalReadLatency(int baseLatency,
                                       int conflictMultiplier,
                                       double bankConflict);
 ...
 * @return Total latency including bank conflict penalty
 */
ORIGAMI_EXPORT int getLocalWriteLatency(int baseLatency,
                                        int conflictMultiplier,
                                        double bankConflict);
