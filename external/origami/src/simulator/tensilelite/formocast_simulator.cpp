...
double Formocast::getLoop_time(MemoryAccessCosts& mem,
                               double math,
                               uint32_t loopCnt,
                               double pgr,
                               uint32_t num_tiles,
  ...
  if (pgr > 1 && loopCnt > 0)
    loop_overall =
        (large || (mem_overall / math >= 1.5) ? (math + mem_overall) / 2 : math) * (loopCnt - 1) +
        mem_overall;
  else
...
Formocast::HardwareConstants Formocast::getHardwareConstants(
  ...
  if (arch == hardware_t::architecture_t::gfx950) {
    unsigned char magic[232] = {
        0,   0,   0,   0,   0,   0,   224, 64,  0,   0,  0,   0,   0,   0,   80,  65,  0,   0,
        0,   0,   0,   0,   176, 65,  0,   0,   0,   0,  0,   0,   96,  64,  0,   0,   0,   0,
        0,   0,   96,  64,  0,   0,   0,   0,   0,   0,  80,  64,  0,   0,   0,   0,   0,   0,
        96,  64,  0,   0,   0,   0,   0,   0,   80,  64, 0,   0,   0,   0,   0,   0,   80,  64,
        0,   0,   0,   0,   0,   0,   8,   64,  0,   0,  0,   0,   0,   176, 157, 64,  189, 134,
        242, 26,  202, 171, 152, 64,  189, 134, 242, 26, 202, 171, 168, 64,  0,   0,   0,   0,
        0,   32,  156, 64,  0,   0,   0,   0,   0,   92, 162, 64,  205, 204, 204, 204, 204, 204,
        4,   64,  205, 204, 204, 204, 204, 204, 0,   64, 0,   0,   0,   0,   0,   0,   176, 64,
        0,   0,   0,   0,   0,   0,   112, 64,  0,   0,  0,   0,   0,   0,   80,  64,  205, 204,
        204, 204, 204, 204, 236, 63,  0,   0,   0,   0,  0,   0,   232, 63,  8,   0,   0,   0,
    ...
    unsigned char magic[232] = {
        ...
        0,  0,   0,   176, 65,  0,  0,   0,   0,   0,   0,   96,  64,  0,   0,   0,   0,   0,   0,
        96, 64,  0,   0,   0,   0,  0,   0,   80,  64,  0,   0,   0,   0,   0,   0,   96,  64,  0,
        0,  0,   0,   0,   0,   80, 64,  0,   0,   0,   0,   0,   0,   80,  64,  0,   0,   0,   0,
        0,  0,   8,   64,  0,   0,  0,   0,   0,   80,  148, 64,  118, 98,  39,  118, 98,  7,   162,
        64, 118, 98,  39,  118, 98, 7,   178, 64,  0,   0,   0,   0,   0,   48,  145, 64,  0,   0,
        0,  0,   0,   48,  161, 64, 154, 153, 153, 153, 153, 153, 5,   64,  0,   0,   0,   0,   0,
        0,  0,   64,  0,   0,   0,  0,   0,   0,   160, 64,  0,   0,   0,   0,   0,   0,   115, 64,
        0,  0,   0,   0,   0,   0,  80,  64,  205, 204, 204, 204, 204, 204, 236, 63,  143, 194, 245,
    ...
    unsigned char magic[232] = {
        ...
        0,   0,   0,   0,   144, 65,  0,   0,   0,   0,   0,   0,   96,  64,  0,   0,  0,   0,
        0,   0,   96,  64,  0,   0,   0,   0,   0,   0,   96,  64,  0,   0,   0,   0,  0,   0,
        96,  64,  0,   0,   0,   0,   0,   0,   80,  64,  0,   0,   0,   0,   0,   0,  96,  64,
        0,   0,   0,   0,   0,   0,   228, 63,  0,   0,   0,   0,   0,   168, 147, 64, 20,  174,
        71,  225, 122, 132, 78,  64,  104, 145, 237, 124, 63,  119, 123, 64,  0,   0,  0,   0,
        0,   92,  162, 64,  0,   0,   0,   0,   0,   136, 163, 64,  51,  51,  51,  51, 51,  51,
        45,  64,  205, 204, 204, 204, 204, 204, 44,  64,  0,   0,   0,   0,   0,   0,  160, 64,
        0,   0,   0,   0,   0,   0,   80,  64,  0,   0,   0,   0,   0,   0,   64,  64, 205, 204,
        204, 204, 204, 204, 236, 63,  0,   0,   0,   0,   0,   0,   232, 63,  1,   0,  0,   0,
        14,  0,   0,   0,   10,  0,   0,   0,   10,  0,   0,   0,   6,   0,   0,   0,  3,   0,
        0,   0,   3,   0,   0,   0,   10,  0,   0,   0,   10,  0,   0,   0,   10,  0,  0,   0,
        4,   0,   0,   0,   2,   0,   0,   0,   1,   0,   0,   0};
    hw              = archConstantMap(magic, 232);
...
double Formocast::calculateStorePerformance(double M,
                                            double N,
                                            double num_tiles,
                                            double NumBatches,
                                            double MT0,
                                            ...
                                            uint32_t WGs_per_tile_full,
                                            uint32_t WGs_per_tile_XCD_full,
                                            double& store,
  ...
  double total_store_req3 =
      simulator::calculateStoreL3Request(M, N, MT0, MT1, D_L3_req, D_L3_edge_req);

  double L2WriteBandWidthPerCU =
      hw_consts.L2WriteArbEff * 128 * 16 / WGs_per_tile_XCD_full;  // 58% eff
  ...
  double store_non_edge_overall = ((D_L1_clk + D_L2_clk) / hw_consts.math_frequency) +
                                  ((D_L3_clk + D_hbm_clk) / hw_consts.mem_frequency);
...
Formocast::L1CacheHitRate Formocast::computeL1CacheHitRate(const HardwareConstants& hw,
                                                           double MT0,
                                                           double MT1,
                                                           uint32_t depthU,
                                                           uint32_t bpeA,
                                                           ...
                                                           uint32_t threadnum,
                                                           uint32_t NumWave0,
                                                           uint32_t NumWave1) const {
  auto hr = simulator::computeL1CacheHitRate(hw.L1CacheCapacity,
                                             hw.L1CacheLineSize,
                                             hw.L1BusWidthPerCU,
                                             MT0,
                                             MT1,
...
Formocast::L3CacheHitRate Formocast::computeL3CacheHitRate(double M,
                                                           double N,
                                                           double K,
                                                           ...
                                                           int M_WGs_total,
                                                           int N_WGs_per_tile,
                                                           int M_WGs_per_tile) const {
  auto hr = simulator::computeL3CacheHitRate(M,
                                             N,
                                             K,
                                             hw.L3CacheCapacity,
                                             hw.NumCUs,
...
double Formocast::calculateGlobalSplitUOverhead(double M,
                                                double N,
                                                double K,
                                                double NumBatches,
                                                double GlobalSplitU,
  ...
  {
    gsu_overall = simulator::getMultipleBufferOverhead(M,
                                                       N,
                                                       GlobalSplitU,
                                                       NumBatches,
                                                       problem.bpeCompute,
                                                       problem.bpeD,
                                                       hw_consts.hbmBandWidth,
                                                       hw_consts.L1CacheLineSize,
                                                       hw_consts.NumCUs,
                                                       num_tiles,
                                                       CUOccupancy,
                                                       hw_consts.boost_frequency,
                                                       hw_consts.mem_frequency,
                                                       hw_consts.L2WriteArbEff,
                                                       hw_consts.L2ReadArbEff,
                                                       hw_consts.L3BandWidth,
...
double Formocast::calculateLocalSplitUOverhead(double MT0,
                                               double MT1,
                                               double lsu,
                                               uint32_t svw,
                                               uint32_t numThreads,
  ...
  return simulator::getLocalSplitKOverhead(
      MT0, MT1, lsu, svw, numThreads, problem.bpeCompute, hw_consts.math_frequency);
}

static void calculateTilesMemory_req_time(Formocast::MemoryAccessCosts& mem_costs,
                                          double A_L1_req,
                                          double A_L2_req,
                                          double A_L3_req,
                                          double A_hbm_req,
                                          ...
                                          double MT1,
                                          uint32_t WGs_per_tile_XCD_full,
                                          uint32_t WGs_per_tile_last,
                                          uint32_t WGs_per_tile_XCD_last,
                                          uint32_t num_tiles) {
  ...
  auto calcLClk = [&](double num_tiles,
                      double L1BandWidthPerCU,
...
Formocast::MemoryAccessCosts Formocast::calculateMTMemoryAccessCosts(double M,
                                                                     double N,
                                                                     double K_AfterGSU,
                                                                     double MT0,
                                                                     double MT1,
                                                                     ...
                                                                     double NumBatches,
                                                                     bool isGSUWGMRR,
                                                                     uint32_t N_WGs_total,
                                                                     uint32_t M_WGs_total,
  ...
  mem.cache_hits.L1_hit = computeL1CacheHitRate(hw,
                                                ...
                                                NumWave0,
                                                NumWave1);
  mem.cache_hits.L2_hit = computeL2CacheHitRate(
      M, N, K_AfterGSU, hw, XCC, XCCG, GlobalSplitU, WGM, NumBatches, bpeA, bpeB, 0, 0, isGSUWGMRR);
  double K = K_AfterGSU * GlobalSplitU;  // Reconstruct original K for L3 cache calculation
  mem.cache_hits.L3_hit = computeL3CacheHitRate(
      M, N, K, hw, bpeA, bpeB, 0, 0, N_WGs_total, M_WGs_total, N_WGs_per_tile, M_WGs_per_tile);

  // 2. Calculate load requests
  double tcc_ea0_coalscedA;
  double tcc_ea0_coalscedB;
  mem.MT_A_L1_req = simulator::getL1LoadRequest(std::min(MT0, M),
                                                depthU,
                                                hw.L1CacheLineSize,
                                                GRVWA,
                                                bpeA,
  ...
  mem.MT_B_L1_req       = simulator::getL1LoadRequest(std::min(MT1, N),
                                                depthU,
                                                hw.L1CacheLineSize,
                                                GRVWB,
                                                bpeB,
  ...
  mem.MT_A_L2_req       = simulator::getL2LoadRequest(
      mem.MT_A_L1_req, mem.cache_hits.L1_hit.tile0HitRate, tcc_ea0_coalscedA);
  mem.MT_A_L3_req = simulator::getL3LoadRequest(
      mem.MT_A_L2_req, mem.cache_hits.L2_hit.tile0HitRate, tcc_ea0_coalscedA);
  mem.MT_A_hbm_req =
      simulator::getHBMLoadRequest(mem.MT_A_L3_req, mem.cache_hits.L3_hit.tile0HitRate);
  mem.MT_B_L2_req = simulator::getL2LoadRequest(
      mem.MT_B_L1_req, mem.cache_hits.L1_hit.tile1HitRate, tcc_ea0_coalscedB);
  mem.MT_B_L3_req = simulator::getL3LoadRequest(
      mem.MT_B_L2_req, mem.cache_hits.L2_hit.tile1HitRate, tcc_ea0_coalscedB);
  mem.MT_B_hbm_req =
      simulator::getHBMLoadRequest(mem.MT_B_L3_req, mem.cache_hits.L3_hit.tile1HitRate);

  mem.l1_hit =
      (mem.cache_hits.L1_hit.tile0HitRate * MT0 + mem.cache_hits.L1_hit.tile1HitRate * MT1) /
      (MT0 + MT1);
  ...
  calculateTilesMemory_req_time(mem,
                                ...
                                MT0,
                                MT1,
                                WGs_per_tile_XCD_full,
                                WGs_per_tile_last,
                                WGs_per_tile_XCD_last,
                                num_tiles);

  return mem;
}

double Formocast::resolveOccupancy(const HardwareConstants& hw,
                                   double perf,
                                   double prefetch,
                                   double mathCost,
                                   double storeCost,
                                   uint32_t num_tiles,
                                   uint32_t CUOccupancy,
                                   uint32_t loopCnt) const {
  if ((num_tiles > 1) && CUOccupancy >= 2) {
    uint32_t tiles = safe_ceil_div(num_tiles, CUOccupancy);
    perf           = hw.initialCost + (prefetch / tiles + mathCost + storeCost * 4 * num_tiles) +
           loopCnt * tiles * 0.1;
...
bool Formocast::isBetter(ProblemInfo problem, TieBreakerInfo previousSolution) const {
  ...
  return compareConfigTieBreaker(problem.M,
                                 problem.N,
                                 problem.K,
                                 problem.NumBatches,
                                 currSol.mt0,
                                 ...
                                 currSol.du,
                                 currSol.svw,
                                 previousSolution.mt0,
                                 previousSolution.mt1,
                                 previousSolution.du,
                                 previousSolution.svw);
}

// NB:
//  isBetter return
//   True means current is better than previous
//   False doesn't means worse, means tie (equal) --> IMPORTANT note since this would be used in
//   std::sort
...
Formocast::TieBreakerInfo Formocast::getTieBreakerInfo() const { return perfInfo; }
...
//   False doesn't means worse, means tie (EQUAL) --> IMPORTANT note since this would be used in
//   std::sort
bool Formocast::isBetter(MinTieBreakerInfo previousSolution,
                         MinTieBreakerInfo currentSolution) const {
  // just early return, return false means equal
  if (previousSolution == currentSolution) return false;
...
Formocast::PredictedPerformance Formocast::predictedPerformance(void) const {
  ...
  uint32_t XCCG   = (sizeMapping.workGroupMappingXCCGroup < 0) ? hw_consts.NumCUs
                                                               : sizeMapping.workGroupMappingXCCGroup;
  ...
  if (problem.dataType == data_type_t::BFloat16 || problem.dataType == data_type_t::Half) {
    if (problem.bpeA == 2 && problem.bpeB == 2)
      if (((K >= 64 && depthU <= 32) || (K <= 32 && depthU > 32) || (K > 32 && depthU > K)) &&
          NumBatches < hw_consts.NumCUs && sizeMapping.matrixInstruction[2] >= 32) {
        pp.microSeconds = 9999999.9;
        pp.hitRate      = 0;
        return pp;
      }
  ...
  int M_WGs_per_tile_XCD =
      std::min(M_WGs_total,
               static_cast<uint32_t>(
                   safe_ceil_div(int(hw_consts.NumCUs / hw_consts.NumXCDs), N_WGs_per_tile_XCD)));
  int M_WGs_per_tile = std::min(
      M_WGs_total, static_cast<uint32_t>(safe_ceil_div(int(hw_consts.NumCUs), N_WGs_per_tile_XCD)));
  int N_WGs_per_tile = std::min(
      N_WGs_total,
      static_cast<uint32_t>(N_WGs_per_tile_XCD * safe_ceil_div(M_WGs_per_tile, M_WGs_total)));
  ...
  uint32_t WGs_per_gsu_XCD =
      safe_ceil_div(safe_ceil_div(std::min(numberWGs, NumCUs), hw_consts.NumXCDs), GlobalSplitU);
  ...
  if (PGR > 1) PGR = sizeMapping.PrefetchGlobalRead;
  ...
  double store_total = calculateStorePerformance(M,
                                                 N,
                                                 num_tiles,
                                                 NumBatches,
                                                 MT0,
  ...
  double lsu_overall =
      calculateLocalSplitUOverhead(MT0, MT1, LSU, GWVWD, NumThreads, problem, hw_consts);
  lsu_overall *= num_tiles;

  MemoryAccessCosts mem_costs = calculateMTMemoryAccessCosts(M,
                                                             N,
                                                             K_AfterGSU,
                                                             MT0,
                                                             MT1,
  ...
  double prefetch   = calculatePrefetchPerformance(PGR,
                                                 GRVWA,
                                                 GRVWB,
                                                 bpeA,
                                                 bpeB,
  ...
  perf = resolveOccupancy(hw_consts,
                          perf,
                          prefetch,
                          loop_overall + tail_overall,
                          store_total,
                          num_tiles,
                          CUOccupancy,
                          loopCnt);
...
Formocast::L2CacheHitRate Formocast::computeL2CacheHitRate(uint32_t M,
                                                           uint32_t N,
                                                           uint32_t K,
                                                           const HardwareConstants& hw,
                                                           uint32_t XCC,
  ...
  auto hr = simulator::computeL2CacheHitRate(M,
                                             N,
                                             K,
                                             MT0,
                                             MT1,
...
void Formocast::setProblem(ProblemInfo p) {
  ...
  if (problem.M == 0 || problem.N == 0 || problem.K == 0)
    throw std::runtime_error("Problem size is invalid");
}

void Formocast::setSolution(SizeMapping sm) { sizeMapping = sm; }

void Formocast::setHardware(hardware_t::architecture_t hw) { hw_consts = getHardwareConstants(hw); }

int Formocast::getGlobalReadQueueFullStallCycles(int currentCycle,
                                                 std::deque<int>& fifo,
                                                 int bpRead,
                                                 int numWaves,
                                                 bool isStall,
                                                 bool isSgprOffset) const {
  return simulator::getGlobalReadQueueFullStallCycles(
      currentCycle, fifo, bpRead, numWaves, isStall, isSgprOffset);
}

int Formocast::getLocalReadCompletionCycle(int currentCycle,
                                           std::queue<int>& fifo,
                                           int numLR) const {
  return simulator::getLocalReadCompletionCycle(currentCycle, fifo, numLR);
}

int Formocast::getLocalReadQueueFullStallCycles(int currentCycle,
                                                std::queue<int>& fifo,
                                                int bpRead,
                                                int numWaves,
                                                bool isStall,
                                                double bankConflict) const {
  int lrStallLatencyBuffer;
  if (!isStall) {
    lrStallLatencyBuffer = 1;
  } else if (bpRead == 16) {
    lrStallLatencyBuffer = simulator::getLocalReadLatency(hw_consts.LocalReadBaseLatencyB128,
                                                          hw_consts.LocalReadConflictMultiplierB128,
                                                          bankConflict);
  } else if (bpRead == 8) {
    lrStallLatencyBuffer = simulator::getLocalReadLatency(
        hw_consts.LocalReadBaseLatencyB64, hw_consts.LocalReadConflictMultiplierB64, bankConflict);
  } else {
    lrStallLatencyBuffer = simulator::getLocalReadLatency(
        hw_consts.LocalReadBaseLatencyB32, hw_consts.LocalReadConflictMultiplierB32, bankConflict);
  }
  return simulator::getLocalReadQueueFullStallCycles(
      currentCycle, fifo, bpRead, numWaves, lrStallLatencyBuffer);
}

int Formocast::getLocalWriteQueueFullStallCycles(int currentCycle,
                                                 int previousLW,
                                                 int issueCycles,
                                                 int bpWrite,
                                                 int numWaves) const {
...
void Formocast::pushLocalReadWrite(int currentCycle,
                                   std::queue<int>& fifo,
                                   int bpr,
                                   double bankConflict,
                                   bool isLocalRead,
  ...
  if (isLocalRead) {
    if (bpr == 16) {
      lrMemLatency = simulator::getLocalReadLatency(hw_consts.LocalReadBaseLatencyB128,
                                                    hw_consts.LocalReadConflictMultiplierB128,
                                                    bankConflict);
      if (numPreviousLRs <= 4) {
      ...
      lrMemLatency = simulator::getLocalReadLatency(hw_consts.LocalReadBaseLatencyB64,
                                                    hw_consts.LocalReadConflictMultiplierB64,
                                                    bankConflict);
    } else {
      lrMemLatency = simulator::getLocalReadLatency(hw_consts.LocalReadBaseLatencyB32,
                                                    hw_consts.LocalReadConflictMultiplierB32,
                                                    bankConflict);
    }
  } else {
    // Local write latency
    if (bpr == 16) {
      lrMemLatency = simulator::getLocalWriteLatency(hw_consts.LocalWriteBaseLatencyB128,
                                                     hw_consts.LocalWriteConflictMultiplierB128,
                                                     bankConflict);
    } else if (bpr == 8) {
      lrMemLatency = simulator::getLocalWriteLatency(hw_consts.LocalWriteBaseLatencyB64,
                                                     hw_consts.LocalWriteConflictMultiplierB64,
                                                     bankConflict);
    } else {
      lrMemLatency = simulator::getLocalWriteLatency(hw_consts.LocalWriteBaseLatencyB32,
                                                     hw_consts.LocalWriteConflictMultiplierB32,
                                                     bankConflict);
    }
  }
...
bool compareConfigTieBreaker(double M,
                             double N,
                             double K,
                             size_t batch,
                             double mt0_a,
  ...
  if (N <= 32 && M >= 1024 && K >= 1024) {
    ...
    if (mt1_a == N && mt1_b == N && skinny_a != skinny_b) { return skinny_a > skinny_b; }
  }
  ...
  if (M <= 32 && N >= 1024 && K >= 1024) {
    ...
    if (mt0_a == M && mt0_b == M && skinny_a != skinny_b) { return skinny_a > skinny_b; }
  }
  ...
  if (batch == 1 && K <= 512 && M >= 1024 && N >= 1024) {
    if (svw_a != svw_b) { return svw_a > svw_b; }
  }
...
Formocast::BankConflictResult Formocast::analyzeBankConflictsFromVGPR(
  ...
  int NUM_BANKS               = 32;
  int BANK_WIDTH              = 4;
  result.ratioA               = simulator::analyzeBankConflictsFromVGPR(vgprState,
                                                          vgprLocalReadAddrA,
                                                          NUM_THREADS_TO_SIMULATE,
                                                          NUM_BANKS,
                                                          BANK_WIDTH,
                                                          LocalReadBytesA);
  result.ratioB               = simulator::analyzeBankConflictsFromVGPR(vgprState,
                                                          vgprLocalReadAddrB,
                                                          NUM_THREADS_TO_SIMULATE,
                                                          NUM_BANKS,
                                                          BANK_WIDTH,
