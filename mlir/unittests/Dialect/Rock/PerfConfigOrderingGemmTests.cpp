...
// gfx950 uses the same non-pow2 K candidate generation as other accelerated
// targets now that peeled-K lowering is fixed there as well.
TEST(PerfConfigOrderingGemmTest, TuningSpaceIncludesNonPow2KDivisorsOnGfx950) {
  // Same K = 576 as the gfx1201 case above.
  const int64_t K = 576;
  TuningSpaceGemmEnv e([](OpBuilder &b) { return b.getF16Type(); },
