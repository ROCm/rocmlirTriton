...
//===----------------------------------------------------------------------===//
//
// The knobs are serialized into the `gemm:` / `attn:` named perfConfig schema
// and consumed by the Rock/Triton lowering pipelines.
//
...
/// `useOptimizeEpilogue`, `useBf16x3ForF32`) plus the debug-only
