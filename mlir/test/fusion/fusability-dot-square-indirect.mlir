...
module {
  func.func @mlir_dot_square(%arg1: tensor<1x2x1280xf32>, %arg2: tensor<1x1280x320xf32>, %arg3: tensor<1x2x320xf32>) -> tensor<1x2x320xf32> attributes {rock.enable_splitk_for_tuning, rock.kernel, rock.arch = "amdgcn-amd-amdhsa:gfx90a:sramecc+:xnack-"} {
    %cst = arith.constant dense<1.000000e+00> : tensor<1x2x320xf32>
    %0 = rock.gemm %arg1 * %arg2 : tensor<1x2x1280xf32> * tensor<1x1280x320xf32> -> tensor<1x2x320xf32>
    %1 = arith.addf %0, %cst : tensor<1x2x320xf32>
    %2 = arith.mulf %1, %0 : tensor<1x2x320xf32>
