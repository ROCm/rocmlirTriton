...
// RUN: sed s/##TOKEN_ARCH##/%arch/g %s | rocmlir-driver -pipeline highlevel | rocmlir-opt --rock-affix-params --rock-conv-to-gemm --rock-gemm-to-gridwise -rock-regularize | FileCheck %s
