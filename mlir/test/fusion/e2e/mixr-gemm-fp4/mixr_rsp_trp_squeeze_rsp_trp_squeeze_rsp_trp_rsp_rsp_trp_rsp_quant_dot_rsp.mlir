...
module {
  func.func @mlir_quant_dot_fp4(%arg0: !migraphx.shaped<1x256x128xf4E2M1FN, 32768x128x1>, %arg1: !migraphx.shaped<1x256x128xf4E2M1FN, 32768x128x1>, %arg2: !migraphx.shaped<1x8x1x128xf32, 1024x128x128x1>, %arg3: !migraphx.shaped<1x8x1x128xf32, 1024x128x128x1>) -> !migraphx.shaped<1x2x8x32x256xf32, 131072x65536x8192x256x1> attributes {rock.kernel} {
