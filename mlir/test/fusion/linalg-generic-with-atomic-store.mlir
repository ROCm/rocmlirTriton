...
module attributes {rock.arch = "amdgcn-amd-amdhsa:gfx90a"} {
  ...
  func.func @rock_gemm(%arg0: memref<1x1024x1024xf32>, %arg1: memref<1x1024x512xf32>, %arg2: memref<1x1024x512xi16> {rock.prefill = 0.000000e+00 : f32}) attributes {block_size = 256 : i32, rock.kernel, rock.arch = "amdgcn-amd-amdhsa:gfx90a"} {
