...
// RUN: rocmlir-driver -pipeline highlevel %s | rocmlir-opt --rock-affix-params --rock-conv-to-gemm --rock-gemm-to-gridwise -rock-regularize -rock-gridwise-gemm-to-blockwise -rock-blockwise-load-tile-to-threadwise -rock-linalg-align | FileCheck %s --check-prefix=CHECK_LINALG_ALIGN
