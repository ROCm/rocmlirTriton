...
module {
  func.func @rock_gemm_gemm(%arg0: tensor<1474560xf16>, %arg1: tensor<1474560xf16>, %arg2: tensor<1474560xf16>, %arg3: tensor<1474560xf16>) -> tensor<1474560xf16> attributes {rock.enable_splitk_for_tuning, rock.kernel, rock.arch = "amdgcn-amd-amdhsa:gfx90a:sramecc+:xnack-"} {
    ...
    %4 = arith.fptoui %3 : tensor<1x4096x360xf16> to tensor<1x4096x360xi8>
    %5 = arith.sitofp %4 : tensor<1x4096x360xi8> to tensor<1x4096x360xf16>
    %6 = rock.transform %5 by #transform_map3 : tensor<1x4096x360xf16> to tensor<1474560xf16>
    %7 = rock.store %6 to %arg3 by set : tensor<1474560xf16> -> tensor<1474560xf16> to tensor<1474560xf16>
