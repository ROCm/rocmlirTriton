...
module {
  func.func @mlir_dot_add(%arg0: tensor<1x2x320xbf16>, %arg1: tensor<1x2x1280xbf16>, %arg2: tensor<1x1280x320xbf16>, %arg3: tensor<1x2x320xbf16>) -> tensor<1x2x320xbf16> attributes {rock.enable_splitk_for_tuning, rock.kernel, rock.arch = "amdgcn-amd-amdhsa:gfx1201"} {
