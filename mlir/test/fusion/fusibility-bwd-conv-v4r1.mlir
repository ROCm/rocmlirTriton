...
// SPLITK: fusible:0
module {  
  func.func @mlir_conv_bwd_data_add_relu(%arg0: memref<1x64x3x7x7xf32>, %arg1: memref<256x1x3x230x230xf32>, %arg2: memref<256x1x64x112x112xf32>, %arg3: memref<64x1x1x1xf32>, %arg4: memref<256x1x64x112x112xf32>) attributes {enable_splitk_for_tuning, rock.kernel = 0 : i32, mhal.arch = "amdgcn-amd-amdhsa:gfx908:sramecc+:xnack-"} {  
    ...
    } : memref<1x64x3x7x7xf32>, memref<256x1x3x230x230xf32>, memref<256x1x64x112x112xf32> -> tensor<256x1x64x112x112xf32>
