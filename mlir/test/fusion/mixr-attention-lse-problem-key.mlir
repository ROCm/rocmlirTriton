...
// CHECK: gfx942
// CHECK-SAME: 304
// CHECK-SAME: -t f16 -transQ false -transK true -transV false -transO false -causal false -return_lse true -split_kv 1 -num_heads_q 1 -num_heads_kv 1 -g 8 -seq_len_q 32 -seq_len_k 32 -head_dim_qk 32 -head_dim_v 32 -with-attn-scale false -with-attn-bias false -transBias false -supportsSplitK false
