...
module {
  func.func @mlir_simplified_issue_(%arg0: memref<1x1x3072xf32>, %arg1: memref<32x384x768xi8>, %arg2: memref<32x768x3072xi8>, %arg3: memref<32x384x3072xi8>) attributes {rock.arch = "gfx1100", rock.block_size = 128 : i32, rock.grid_size = 2304 : i32, rock.kernel = "mixr", rock.num_cu = 48 : i64, wave_size = 32 : i32} {
