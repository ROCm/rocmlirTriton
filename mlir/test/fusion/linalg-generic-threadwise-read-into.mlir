...
// RUN: rocmlir-driver -pipeline=gpu --verify-passes %s | rocmlir-opt

#map0 = affine_map<(d0, d1, d2) -> (d0, d1, d2)>

module attributes {rock.arch = "amdgcn-amd-amdhsa:gfx1100"} {
  func.func @rock_gemm(%arg0: memref<1x1x1xf16>, %arg1: memref<1x1x1xf32>, %arg2: memref<1x1x1xf32>) attributes {kernel, rock.arch = "amdgcn-amd-amdhsa:gfx1100"} {
