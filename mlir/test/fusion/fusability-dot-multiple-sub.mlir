...
module {
  func.func @mlir_dot_add(%arg0: memref<1x2x320xf32>, %arg1: memref<1x2x320xf16>, %arg2: memref<1x2x1280xf32>, %arg3: memref<1x1280x320xf32>, %arg4: memref<1x2x320xf16>) attributes {enable_splitk_for_tuning, kernel, rock.arch = "amdgcn-amd-amdhsa:gfx90a:sramecc+:xnack-"} {
