// RUN: sed s/##TOKEN_ARCH##/%arch/g %s | rocmlir-driver -kernel-pipeline=gpu -arch %arch | rocmlir-opt
...
func.func @mlir_dot_mul(%arg0: tensor<6xf32>, %arg1: tensor<12xf32>, %arg2: tensor<8xf32>, %arg3: tensor<8xf32>) -> (tensor<8xf32>, tensor<8xf32>) attributes {rock.arch = "##TOKEN_ARCH##", rock.kernel = "mixr"} {
