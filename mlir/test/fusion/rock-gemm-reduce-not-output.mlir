...
// CHECK: rock.reduce result can be used by rock.store only
...
module {
  func.func @matmul_broadcast_op(%arg0: tensor<262144xf32>, %arg1: tensor<16777216xf32>, %arg2: tensor<262144xf32>, %arg3: tensor<4096xf32> {rock.prefill = 0.000000e+00 : f32}) -> tensor<4096xf32> attributes {rock.arch = "gfx942:sramecc+:xnack-", rock.enable_splitk_for_tuning, rock.kernel = "mixr"} {
    ...
    %gemm_3d = rock.transform %gemm by #transform_map6 : tensor<4096x64xf32> to tensor<64x64x64xf32>
    %fused_add = arith.addf %gemm_3d, %0 : tensor<64x64x64xf32>
    %reduced = rock.reduce sum %fused_add {axis = 2 : index} : tensor<64x64x64xf32> -> tensor<64x64x1xf32>
    %7 = rock.transform %reduced by #transform_map7 : tensor<64x64x1xf32> to tensor<64x64xf32>
    %relu = arith.maximumf %7, %cst : tensor<64x64xf32>
    %8 = rock.transform %relu by #transform_map8 : tensor<64x64xf32> to tensor<64x64x1xf32>
    %9 = rock.transform %8 by #transform_map9 : tensor<64x64x1xf32> to tensor<4096xf32>
    %out = rock.store %9 to %arg3 by set : tensor<4096xf32> -> tensor<4096xf32> to tensor<4096xf32>
