...
module {
  func.func @rock_gemm_gemm(%arg0: tensor<1474560xf16>, %arg1: tensor<1474560xf16>, %arg2: tensor<1474560xf16>, %arg3: tensor<4096xi8>) -> tensor<4096xi8> attributes {rock.enable_splitk_for_tuning, rock.kernel, rock.arch = "amdgcn-amd-amdhsa:gfx942:sramecc+:xnack-"} {
    ...
    %6 = arith.fptosi %5 : tensor<4096xf16> to tensor<4096xi8>
    %7 = rock.store %6 to %arg3 by set : tensor<4096xi8> -> tensor<4096xi8> to tensor<4096xi8>
    return %7 : tensor<4096xi8>
  }
}
