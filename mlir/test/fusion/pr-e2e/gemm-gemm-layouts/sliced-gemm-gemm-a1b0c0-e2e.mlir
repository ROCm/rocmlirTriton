...
module {
  func.func @test(%arg0: !migraphx.shaped<1x32x32xf32, 1024x1x32>, %arg1: !migraphx.shaped<1x64x16xf32, 1024x1x64>, %arg2: !migraphx.shaped<1x8x64xf32, 512x1x8>) -> !migraphx.shaped<1x32x8xf32, 256x8x1> attributes {rock.kernel} {
