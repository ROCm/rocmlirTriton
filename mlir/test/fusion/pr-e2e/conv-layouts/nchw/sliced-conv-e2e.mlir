...
module {
  func.func @test(%arg0: !migraphx.shaped<2x160x160x32xf16, 819200x160x1x25600>, %arg1: !migraphx.shaped<16x16x3x3xf16, 144x1x48x16>, %arg2: !migraphx.shaped<2x16x160x160xf16, 0x1x0x0>) -> !migraphx.shaped<2x16x160x160xf16, 409600x1x2560x16>  attributes {rock.kernel} {
