// RUN: sed s/##TOKEN_ARCH##/%arch/g %s | rocmlir-driver -pipeline migraphx,highlevel | rocmlir-opt -rock-affix-params -rock-conv-to-gemm -rock-gemm-to-gridwise --rock-regularize -rock-gridwise-gemm-to-blockwise -rock-blockwise-load-tile-to-threadwise -rock-linalg-align | FileCheck %s
