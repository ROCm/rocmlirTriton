// RUN: sed s/##TOKEN_ARCH##/%arch/g %s | rocmlir-driver -kernel-pipeline migraphx,highlevel | rocmlir-driver -c --arch %arch -mlir-print-ir-after=rock-lower-stores -o /dev/null 2>&1 | FileCheck %s
