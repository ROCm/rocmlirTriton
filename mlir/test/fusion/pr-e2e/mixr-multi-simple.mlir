...
// UNSUPPORTED: true
// RUN: rocmlir-gen -fut multi_simpl --arch %arch --clone-harness %s | rocmlir-driver -kernel-pipeline=migraphx,highlevel -host-pipeline=migraphx,highlevel | rocmlir-gen -ph -rand 1 -rand_type float -fut multi_simpl --verifier clone -| rocmlir-driver -c | mlir-runner --shared-libs=%linalg_test_lib_dir/libmlir_rocm_runtime%shlibext,%conv_validation_wrapper_library_dir/libconv-validation-wrappers%shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext,%linalg_test_lib_dir/libmlir_float16_utils%shlibext,%linalg_test_lib_dir/libmlir_c_runner_utils%shlibext,%linalg_test_lib_dir/libmlir_async_runtime%shlibext --entry-point-result=void | FileCheck %s

// CHECK: [1 1 1]
// CHECK: [1 1 1]
module {
  func.func @multi_simpl(%arg0: !migraphx.shaped<2x128x64x64xf16, 0x1x0x0>, %arg1: !migraphx.shaped<2x64x64x64xf16, 262144x1x4096x64>, %arg2: !migraphx.shaped<128x64x1x1xf16, 64x1x8192x8192>) -> (!migraphx.shaped<2x128x64x64xf16, 524288x1x8192x128>, !migraphx.shaped<2x128x64x64xf16, 524288x1x8192x128>) attributes {rock.kernel}
  {
