...
// UNSUPPORTED: true
// RUN: rocmlir-gen -fut mlir_conv_gemm --arch %arch --clone-harness %s | rocmlir-driver -kernel-pipeline=migraphx,highlevel -host-pipeline=migraphx,highlevel | rocmlir-gen -ph -rand 1 -rand_type float -fut mlir_conv_gemm --verifier clone - | rocmlir-driver -c | mlir-runner --shared-libs=%linalg_test_lib_dir/libmlir_rocm_runtime%shlibext,%conv_validation_wrapper_library_dir/libconv-validation-wrappers%shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext,%linalg_test_lib_dir/libmlir_float16_utils%shlibext,%linalg_test_lib_dir/libmlir_c_runner_utils%shlibext,%linalg_test_lib_dir/libmlir_async_runtime%shlibext --entry-point-result=void | FileCheck %s
// CHECK: [1 1 1]

module {
  func.func @mlir_conv_gemm(%arg0: !migraphx.shaped<2x8x8x16xf16, 1024x8x1x64>, %arg1: !migraphx.shaped<16x16x3x3xf16, 144x1x48x16>, %arg2: !migraphx.shaped<2x16x8x8xf16, 0x1x0x0>, %arg3: !migraphx.shaped<2x16x8x8xf16, 0x1x0x0>, %arg4: !migraphx.shaped<1x16x32xf16, 0x1x0>) -> !migraphx.shaped<1x128x32xf16, 4096x32x1>  attributes {rock.kernel} {
