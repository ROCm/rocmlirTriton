...
// CHECK: [1 1 1]
module {
  func.func @mlir_convolution_multi_output_add(%arg0: !migraphx.shaped<2x4x64x64xf16, 16384x4096x64x1>, %arg1: !migraphx.shaped<320x4x3x3xf16, 36x9x3x1>) -> (!migraphx.shaped<2x320x64x64xf16, 1310720x4096x64x1>, !migraphx.shaped<2x320x64x64xf16, 1310720x4096x64x1>) attributes {rock.kernel} {
    ...
    %4 = migraphx.convolution %arg0, %arg1 {perf_config="gemm:v1:16,32,4,1,1,4,16,2,1,0,0", dilation = [1, 1], group = 1 : i64, padding = [1, 1, 1, 1], padding_mode = 0 : i64, stride = [1, 1]} : <2x4x64x64xf16, 16384x4096x64x1>, <320x4x3x3xf16, 36x9x3x1> -> <2x320x64x64xf16, 1310720x4096x64x1>
