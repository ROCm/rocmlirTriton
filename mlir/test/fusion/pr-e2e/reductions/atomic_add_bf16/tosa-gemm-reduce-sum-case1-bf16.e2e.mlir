// TODO(rocmlirTriton): Unstable tests, observing [1 1 1] and [1 0 1] interchangeably. Reported in ticket: AIROCMLIR-800
// UNSUPPORTED: true
...
func.func private @dot_add(%arg0: tensor<1x128x64xbf16>, %arg1: tensor<1x64x256xbf16>) -> tensor<1x128x1xbf16> attributes {rock.kernel} {
  ...
  %0 = "tosa.matmul"(%arg0, %arg1, %a_zp, %b_zp) {perf_config = "gemm:v1:128,64,32,1,1,4,0,1,2,0,0"} : (tensor<1x128x64xbf16>, tensor<1x64x256xbf16>, tensor<1xbf16>, tensor<1xbf16>) -> tensor<1x128x256xbf16>
