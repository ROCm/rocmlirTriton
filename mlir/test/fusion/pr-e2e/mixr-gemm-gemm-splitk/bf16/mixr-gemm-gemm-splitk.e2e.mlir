// RUN: rocmlir-gen -fut mlir_gemm_gemm --arch %arch --clone-harness %s | rocmlir-driver -kernel-pipeline=migraphx,highlevel -host-pipeline=migraphx,highlevel | rocmlir-gen -ph -rand 1 -rand_min -1 -rand_max 1 -rand_type float -fut mlir_gemm_gemm --verifier clone - | rocmlir-driver -c | mlir-runner --shared-libs=%linalg_test_lib_dir/libmlir_rocm_runtime%shlibext,%conv_validation_wrapper_library_dir/libconv-validation-wrappers%shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext,%linalg_test_lib_dir/libmlir_float16_utils%shlibext,%linalg_test_lib_dir/libmlir_c_runner_utils%shlibext,%linalg_test_lib_dir/libmlir_async_runtime%shlibext --entry-point-result=void | FileCheck %s
// CHECK: [1 1 1]
...
module {
  func.func @mlir_gemm_gemm(%arg0: !migraphx.shaped<1x64x64xbf16, 4096x64x1>, %arg1: !migraphx.shaped<1x64x64xbf16, 4096x64x1>, %arg2: !migraphx.shaped<1x64x64xbf16, 4096x64x1>) -> (!migraphx.shaped<1x64x64xbf16, 4096x64x1>) attributes {rock.kernel} {
    ...
    %1 = migraphx.dot %0, %arg2 {perf_config="attn:mPerBlockG0=128,nPerBlockG0=64,kPerBlock=32,numWaves=4,matrixInstrNonkdim=0,splitKFactor=4"} : !migraphx.shaped<1x64x64xbf16, 4096x64x1>, !migraphx.shaped<1x64x64xbf16, 4096x64x1> -> !migraphx.shaped<1x64x64xbf16, 4096x64x1>
