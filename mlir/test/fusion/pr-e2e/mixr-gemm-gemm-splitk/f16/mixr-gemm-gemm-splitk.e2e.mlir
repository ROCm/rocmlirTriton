...
module {
  func.func @mlir_gemm_gemm(%arg0: !migraphx.shaped<1x64x64xf16, 4096x64x1>, %arg1: !migraphx.shaped<1x64x64xf16, 4096x64x1>, %arg2: !migraphx.shaped<1x64x64xf16, 4096x64x1>) -> (!migraphx.shaped<1x64x64xf16, 4096x64x1>) attributes {rock.kernel} {
    ...
    %1 = migraphx.dot %0, %arg2 {perf_config="attn:mPerBlockG0=128,nPerBlockG0=64,kPerBlock=32,numWaves=4,matrixInstrNonkdim=0,splitKFactor=4"} : !migraphx.shaped<1x64x64xf16, 4096x64x1>, !migraphx.shaped<1x64x64xf16, 4096x64x1> -> !migraphx.shaped<1x64x64xf16, 4096x64x1>
