...
module {
  func.func @mlir_conv_gemm(%arg0: !migraphx.shaped<2x8x8x16xf32, 1024x8x1x64>, %arg1: !migraphx.shaped<16x16x3x3xf32, 144x1x48x16>, %arg2: !migraphx.shaped<1x16x32xf32, 0x1x0>) -> !migraphx.shaped<1x128x32xf32, 4096x32x1> attributes {rock.kernel} {
