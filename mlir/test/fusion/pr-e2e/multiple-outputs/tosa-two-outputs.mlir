...
// CHECK-COUNT-2:  [1 1 1]
module {
  func.func @test_mo(%arg0: tensor<1x256x768xf32>, %arg1: tensor<1x768x768xf32>, %arg2: tensor<1x256x1xf32>, %arg3: tensor<1x256x768xf32>) -> (tensor<1x256x768xf32>, tensor<1x256x768xf32>) attributes {rock.kernel} {
    ...
    %2 = "tosa.matmul"(%0, %1, %a_zp, %b_zp) {acc_type = f32} : (tensor<1x256x768xf32>, tensor<1x768x768xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<1x256x768xf32>
