...
// attention and softmax and producing NaN/garbage outputs.

// RUN: rocmlir-gen --arch %arch --operation attention -t i8 --num_cu 70 --num_chiplets 1 -g 1 -seq_len_q 20 -seq_len_k 3900 -num_heads_q 128 -num_heads_kv 32 -head_dim_qk 191 -head_dim_v 122 -with-attn-scale=True -with-attn-bias=True -transQ=False -transK=False -transV=True -transO=True -causal=True -return_lse=True -split_kv=32 --perf_config=attn:v1:16,32,128,2,1,8,16,1,3,2,1 -pv \
