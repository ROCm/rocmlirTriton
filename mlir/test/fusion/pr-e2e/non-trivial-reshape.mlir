...
// CHECK: [1 1 1]
module {
    func.func @bert_part_19(%arg0: tensor<1x12x12x32xf32> {mhal.read_access}, %arg1: tensor<1x12x32x12xf32> {mhal.read_access}, %arg2: tensor<1x1x1x1xf32> {mhal.read_access}, %arg3: tensor<1x1x1x12xf32> {mhal.read_access}) -> (tensor<1x12x12x12xf32> {mhal.write_access}) attributes {rock.kernel} {
