// TODO(rocmlirTriton): expected string not found in input
// UNSUPPORTED: false
...
module {
  func.func @test(%arg0: !migraphx.shaped<1x32x32xf16, 1024x1x32>, %arg1: !migraphx.shaped<1x64x16xf16, 1024x1x64>, %arg2: !migraphx.shaped<1x64x8xf16, 512x1x64>) -> !migraphx.shaped<1x32x8xf16, 256x8x1>  attributes {rock.kernel} {
