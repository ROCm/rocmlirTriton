...
// in this example means that half of the memory is uninitialized. A few of the
// initialized f16 sigmoid values can differ from the clone by 1 ULP, so the
// exact-match count sits slightly below 2304.
// CHECK: zero_diff: {{2[23][0-9][0-9]}}/4608
// CHECK: [0 0 0]
