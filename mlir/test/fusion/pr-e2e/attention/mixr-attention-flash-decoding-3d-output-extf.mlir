...
//
// rtol is loosened from the allclose default because upstream gates the whole
// pr-e2e/attention directory behind MFMA, so its tolerances were only ever
// tuned for gfx9. On WMMA parts the f16 second GEMM accumulates differently
// and the worst element lands around 0.9% relative.
