...
// KPACK: #[[MFMA:mma[0-9]*]] = #ttg.amd_mfma<{{.*}}instrShape = [16, 16, 16]{{.*}}>
// KPACK: tensor<64x16xf16, #ttg.dot_op<{opIdx = 0, parent = #[[MFMA]], kWidth = 4}>>
// KPACK: tensor<16x256xf16, #ttg.dot_op<{opIdx = 1, parent = #[[MFMA]], kWidth = 4}>>
