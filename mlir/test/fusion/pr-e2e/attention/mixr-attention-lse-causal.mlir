...
// CHECK: [1 1 1]
module {
  func.func @mlir_attention(%arg0: !migraphx.shaped<1x96x2x128xf16, 24576x128x12288x1>, %arg1: !migraphx.shaped<1x32x64x128xf16, 262144x8192x128x1>, %arg2: !migraphx.shaped<1x32x64x128xf16, 262144x8192x128x1>) -> (!migraphx.shaped<1x2x4096xf16, 8192x4096x1>, !migraphx.shaped<1x32x2x1xf16, 64x2x1x1>)  attributes {rock.kernel} {
