...
module {
  func.func @mlir_attention(%arg0: !migraphx.shaped<1x12x256x256xf32, 786432x65536x256x1>, %arg1: !migraphx.shaped<1x12x256x256xf32, 786432x65536x256x1>, %arg2: !migraphx.shaped<1x12x256x256xf32, 786432x65536x256x1>) -> (!migraphx.shaped<1x12x2x256x256xf32, 1572864x131072x65536x256x1>, !migraphx.shaped<1x12x2x256x1xf32, 6144x512x256x1x1>) attributes {rock.kernel} {
