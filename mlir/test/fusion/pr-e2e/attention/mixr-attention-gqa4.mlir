...
// CHECK: [1 1 1]
module {
  func.func @mlir_attention(%arg0: !migraphx.shaped<2x18x4x64xf16, 4608x64x1152x1>, %arg1: !migraphx.shaped<2x2x8x64xf16, 1024x512x64x1>, %arg2: !migraphx.shaped<2x2x8x64xf16, 1024x512x64x1>, %arg3: !migraphx.shaped<2x1xsi32, 1x1>) -> !migraphx.shaped<2x4x896xf16, 3584x896x1>  attributes {rock.kernel} {
