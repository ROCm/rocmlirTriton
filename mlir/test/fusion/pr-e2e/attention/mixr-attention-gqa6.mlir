...
// CHECK: [1 1 1]
module {
  func.func @mlir_attention(%arg0: !migraphx.shaped<2x1xsi32, 1x1>, %arg1: !migraphx.shaped<2x18x1x64xf16, 1152x64x64x1>, %arg2: !migraphx.shaped<2x2x8x64xf16, 1024x512x64x1>, %arg3: !migraphx.shaped<2x2x8x64xf16, 1024x512x64x1>) -> !migraphx.shaped<2x1x896xf16, 896x896x1>  attributes {rock.kernel} {
