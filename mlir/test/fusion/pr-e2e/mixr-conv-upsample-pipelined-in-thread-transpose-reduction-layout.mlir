...
// marks the load rock.loop_variant_index_math and
// rock-set-in-thread-transpose-reduction-layout moves every warp of that load
// onto K, for both the prologue and the in-loop loads staged into the same
