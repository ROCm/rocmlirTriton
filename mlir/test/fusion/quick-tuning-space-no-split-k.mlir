// RUN: rocmlir-driver -kernel-pipeline=migraphx,highlevel %s | rocmlir-gen --emit-tuning-space=quick - | FileCheck %s --implicit-check-not='splitKFactor={{[2-9][0-9]*}}'
...
module {
  func.func @conv_add_relu(%input: !migraphx.shaped<1x3x32x32xf32, 3072x1024x32x1>,
      ...
      attributes {rock.arch = "gfx1100", rock.kernel = "mixr"} {
