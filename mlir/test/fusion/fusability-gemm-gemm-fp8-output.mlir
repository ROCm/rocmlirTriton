// RUN: rocmlir-gen -emit-module-fusibility-for=attn:v1:64,64,16,1,1,4,16,4,2,0,0 - < %s | FileCheck %s --check-prefix=CHECK-SPLITK
// CHECK-SPLITK: fusible:0
// RUN: rocmlir-gen -emit-module-fusibility-for=attn:v1:64,64,16,1,1,4,16,1,2,0,0 - < %s | FileCheck %s --check-prefix=CHECK-NONSPLITK
...
module {
  func.func @rock_gemm_gemm(%arg0: tensor<1474560xf16>, %arg1: tensor<1474560xf16>, %arg2: tensor<1474560xf16>, %arg3: tensor<4096xf8E4M3FNUZ>) -> tensor<4096xf8E4M3FNUZ> attributes {rock.enable_splitk_for_tuning, rock.kernel, rock.arch = "amdgcn-amd-amdhsa:gfx942:sramecc+:xnack-"} {
    ...
    %6 = arith.truncf %5 : tensor<4096xf16> to tensor<4096xf8E4M3FNUZ>
    %7 = rock.store %6 to %arg3 by set : tensor<4096xf8E4M3FNUZ> -> tensor<4096xf8E4M3FNUZ> to tensor<4096xf8E4M3FNUZ>
    return %7 : tensor<4096xf8E4M3FNUZ>
  }
}
