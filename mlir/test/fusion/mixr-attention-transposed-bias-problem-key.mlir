...
// CHECK: gfx942
// CHECK-SAME: 304
// CHECK-SAME: -t f32 -transQ false -transK false -transV false -transO false -causal false -return_lse false -split_kv 1 -num_heads_q 1 -num_heads_kv 1 -g 1 -seq_len_q 5 -seq_len_k 7 -head_dim_qk 3 -head_dim_v 3 -with-attn-scale false -with-attn-bias true -transBias true -supportsSplitK false
module
{
