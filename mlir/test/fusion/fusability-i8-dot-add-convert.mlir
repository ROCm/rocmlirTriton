...
module {
  func.func @mlir_dot_add(%arg0: tensor<1x2x320xf16>, %arg1: tensor<1x2x1280xi8>, %arg2: tensor<1x1280x320xi8>, %arg3: tensor<1x2x320xf16>) -> tensor<1x2x320xf16> attributes {rock.enable_splitk_for_tuning, rock.kernel, rock.arch = "amdgcn-amd-amdhsa:gfx90a:sramecc+:xnack-"} {
