// TODO(rocmlirTriton): missing LLVMTranslationDialectInterface registration for dialect for op: bufferization.alloc_tensor
// UNSUPPORTED: true
// RUN: rocmlir-gen -fut mlir_conv_gemm --arch %arch --clone-harness %s | rocmlir-driver -kernel-pipeline=migraphx,highlevel -host-pipeline=migraphx,highlevel | rocmlir-gen -ph -RMS_threshold 0.01 -rand 1 -rand_type float -fut mlir_conv_gemm --verifier clone - | rocmlir-driver -c | mlir-runner --shared-libs=%linalg_test_lib_dir/libmlir_rocm_runtime%shlibext,%conv_validation_wrapper_library_dir/libconv-validation-wrappers%shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext,%linalg_test_lib_dir/libmlir_float16_utils%shlibext,%linalg_test_lib_dir/libmlir_c_runner_utils%shlibext,%linalg_test_lib_dir/libmlir_async_runtime%shlibext --entry-point-result=void | FileCheck %s
// CHECK: [1 1 1]
module {
  func.func private @mlir_conv_gemm(%arg0: !migraphx.shaped<2x64x32x32xf16, 65536x1x2048x64>,
                                    ...
                                    %arg3: !migraphx.shaped<1x2048x64xf16, 0x0x1>) -> (!migraphx.shaped<1x2048x16xf16, 32768x16x1>) attributes {rock.kernel} {
