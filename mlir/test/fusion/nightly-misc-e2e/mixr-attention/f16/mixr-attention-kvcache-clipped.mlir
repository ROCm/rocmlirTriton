...
// IR-DAG: %[[CLIP_MAX:.*]] = arith.constant dense<2> : tensor<2xi32>
// IR-DAG: %[[CLIP_MIN:.*]] = arith.constant dense<0> : tensor<2xi32>
// IR: %[[MAXED:.*]] = arith.maxsi %{{.*}}, %[[CLIP_MIN]] : tensor<2xi32>
// IR: %[[CLIPPED:.*]] = arith.minsi %[[MAXED]], %[[CLIP_MAX]] : tensor<2xi32>
// IR: rock.attention
