...
// Note, this is a different error than the one that was fixed in https://github.com/ROCm/rocmlirTriton/pull/95.
// This seems to be related to fusion handling in GridwiseAttnToBlockwise.cpp
// UNSUPPORTED: true
