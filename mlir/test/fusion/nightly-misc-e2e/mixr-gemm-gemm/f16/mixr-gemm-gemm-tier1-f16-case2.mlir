...
// CHECK: [1 1 1]
module {
  func.func private @mlir_gemm_gemm(%arg0: !migraphx.shaped<2x16x384x64xf16, 393216x24576x64x1>, %arg1: !migraphx.shaped<2x16x64x384xf16, 393216x24576x384x1>, %arg2: !migraphx.shaped<2x16x384x64xf16, 393216x24576x64x1>) -> (!migraphx.shaped<2x16x384x64xf16, 393216x24576x64x1>) attributes {rock.kernel} {
