...
// CHECK: [1 1 1]
module {
  func.func private @mlir_gemm_gemm(%arg0: !migraphx.shaped<1x12x384x64xf32, 294912x24576x64x1>, %arg1: !migraphx.shaped<1x12x64x384xf32, 294912x24576x384x1>, %arg2: !migraphx.shaped<1x12x384x64xf32, 294912x24576x64x1>) -> (!migraphx.shaped<1x12x384x64xf32, 294912x24576x64x1>) attributes {rock.kernel} {
