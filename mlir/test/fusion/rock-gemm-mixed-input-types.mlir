...
module attributes {rock.arch = "##TOKEN_ARCH##"} {
  func.func @rock_gemm(%arg0: tensor<787456xf16>, %arg1: tensor<393728xf32>, %arg2: tensor<524288xf32>) -> tensor<524288xf32> attributes {rock.kernel, rock.arch = "##TOKEN_ARCH##"} {
