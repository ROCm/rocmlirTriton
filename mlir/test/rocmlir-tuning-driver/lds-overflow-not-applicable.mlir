...
//
// The chosen tile (mPerBlock=nPerBlock=256, kPerBlock=128, kpack=1, f32)
// allocates well over 64 KB of shared memory, which exceeds the LDS budget
// on every currently supported architecture (gfx90a/942/950/1100/1200/1250).
//
...
// RUN:     --benchmark-config="gemm:v1:256,256,128,1,1,4,16,1,2,0,0" 2>&1 \
// RUN: | FileCheck %s \
...
// CHECK: gemm:v1:256,256,128,1,1,4,16,1,2,0,0{{[[:space:]]+}}N/A
