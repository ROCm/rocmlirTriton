// UNSUPPORTED: true
// TODO(rocmlirTriton): to be fixed in https://amd-hub.atlassian.net/browse/AIROCMLIR-592
...
// MIXED_DTYPE: func.func @rock_conv_bwd_data{{.*}}(%arg0: tensor<{{[0-9]+}}xf16>, %arg1: tensor<{{[0-9]+}}xf32>, %arg2: tensor<{{[0-9]+}}xf16>)
// MIXED_DTYPE: func.func @conv_bwd_data_cpu(%arg0: tensor<{{[0-9]+}}xf16>, %arg1: tensor<{{[0-9]+}}xf32>, %arg2: tensor<{{[0-9]+}}xf16>) -> tensor<{{[0-9]+}}xf32>
