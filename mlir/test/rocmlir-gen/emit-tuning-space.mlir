...
// CHECK-MI: gemm:v3:64,64,128,1,1,4,16,4,1,0,0,-1,-1,-1,-1,-1
...
// CHECK-EXHAUSTIVE-MATRIXINSTRNONKDIM: gemm:v3:16,16,16,1,1,1,16,1,1,0,0,-1,-1,-1,-1,-1
// CHECK-EXHAUSTIVE-MATRIXINSTRNONKDIM: gemm:v3:16,16,16,1,1,1,32,1,1,0,0,-1,-1,-1,-1,-1
...
// CHECK-EXHAUSTIVE-SPLITKFACTOR: gemm:v3:16,16,16,1,1,1,16,1,1,0,0,-1,-1,-1,-1,-1
// CHECK-EXHAUSTIVE-SPLITKFACTOR: gemm:v3:16,16,16,1,1,1,16,3,1,0,0,-1,-1,-1,-1,-1
// CHECK-EXHAUSTIVE-SPLITKFACTOR: gemm:v3:16,16,16,1,1,1,16,4,1,0,0,-1,-1,-1,-1,-1
...
// CHECK-EXHAUSTIVE-NUMSTAGES: gemm:v3:16,16,16,1,1,1,16,1,1,0,0,-1,-1,-1,-1,-1
// CHECK-EXHAUSTIVE-NUMSTAGES: gemm:v3:16,16,16,1,1,1,16,1,2,0,0,-1,-1,-1,-1,-1
// CHECK-EXHAUSTIVE-NUMSTAGES: gemm:v3:16,16,16,1,1,1,16,1,3,0,0,-1,-1,-1,-1,-1
...
// CHECK-EXHAUSTIVE-ATTN: attn:v3:16,16,16,1,1,1,16,1,1,0,0,-1,-1,-1,-1,-1
...
// RUN:       --implicit-check-not="gemm:v3:{{[0-9]+,[0-9]+,[0-9]+,2,}}"
// CHECK-MFMA-GFX950-KPACK: gemm:v3:{{[0-9]+,[0-9]+,[0-9]+,1,}}
...
// RUN:       --implicit-check-not="gemm:v3:{{[0-9]+,[0-9]+,[0-9]+,2,}}"
// CHECK-WMMA-GEMM-KPACK-F16: gemm:v3:{{[0-9]+,[0-9]+,[0-9]+,1,}}
...
// RUN:       --implicit-check-not="attn:v3:{{[0-9]+,[0-9]+,[0-9]+,2,}}"
// CHECK-WMMA-ATTN-KPACK: attn:v3:{{[0-9]+,[0-9]+,[0-9]+,1,}}
...
// RUN:       --implicit-check-not="gemm:v3:{{[0-9]+,[0-9]+,(32|64|128|256|512),}}" \
// RUN:       --implicit-check-not="gemm:v3:{{[0-9]+,[0-9]+,[0-9]+,2,}}" \
// RUN:       --implicit-check-not="gemm:v3:{{[0-9]+,[0-9]+,[0-9]+,[0-9]+,[0-9]+,[0-9]+,(16|32),}}"
// CHECK-NAVI: gemm:v3:{{(32|64|128),(32|64|128),(4|8|16),1,[0-9]+,[0-9]+,0,[0-9]+,[0-9]+,0,0,-1,-1,-1,-1,-1}}
...
// RUN:       --implicit-check-not="attn:v3:{{[0-9]+,[0-9]+,[0-9]+,2,}}" \
// RUN:       --implicit-check-not="attn:v3:{{[0-9]+,[0-9]+,[0-9]+,[0-9]+,[0-9]+,[0-9]+,(16|32),}}" \
// RUN:       --implicit-check-not="attn:v3:{{(16|256),}}" \
// RUN:       --implicit-check-not="attn:v3:{{[0-9]+,(16|256),}}"
// CHECK-NAVI-ATTN: attn:v3:{{(32|64|128),(32|64|128),[0-9]+,1,[0-9]+,[0-9]+,0,(1|2),[0-9]+,0,0,-1,-1,-1,-1,-1}}
