...
// RUN:       --implicit-check-not="gemm:v1:{{[0-9]+,[0-9]+,[0-9]+,2,}}"
// CHECK-WMMA-GEMM-KPACK: gemm:v1:{{[0-9]+,[0-9]+,[0-9]+,1,}}
...
// RUN:       --implicit-check-not="attn:v1:{{[0-9]+,[0-9]+,[0-9]+,2,}}"
// CHECK-WMMA-ATTN-KPACK: attn:v1:{{[0-9]+,[0-9]+,[0-9]+,1,}}
...
// RUN:       --implicit-check-not="gemm:v1:{{[0-9]+,[0-9]+,[0-9]+,2,}}"
// CHECK-MFMA-GFX950-KPACK: gemm:v1:{{[0-9]+,[0-9]+,[0-9]+,1,}}
