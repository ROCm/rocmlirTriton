...
// CHECK_1: -t f32 -transQ false -transK false -transV false -transO false -causal false -return_lse false -split_kv 1 -num_heads_q 1 -num_heads_kv 1 -g 1 -seq_len_q 256 -seq_len_k 512 -head_dim_qk 64 -head_dim_v 32 -with-attn-scale false -with-attn-bias false -transBias false -supportsSplitK false
...
// CHECK_2: -t f16 -transQ false -transK false -transV false -transO false -causal false -return_lse false -split_kv 1 -num_heads_q 1 -num_heads_kv 1 -g 4 -seq_len_q 256 -seq_len_k 512 -head_dim_qk 64 -head_dim_v 32 -with-attn-scale false -with-attn-bias false -transBias false -supportsSplitK false
...
// CHECK_3: -t i8 -transQ false -transK false -transV false -transO false -causal false -return_lse false -split_kv 1 -num_heads_q 1 -num_heads_kv 1 -g 8 -seq_len_q 256 -seq_len_k 512 -head_dim_qk 64 -head_dim_v 32 -with-attn-scale false -with-attn-bias false -transBias false -supportsSplitK false
...
// CHECK_4: -t i8 -transQ false -transK false -transV false -transO false -causal false -return_lse false -split_kv 1 -num_heads_q 4 -num_heads_kv 4 -g 8 -seq_len_q 256 -seq_len_k 512 -head_dim_qk 64 -head_dim_v 32 -with-attn-scale false -with-attn-bias false -transBias false -supportsSplitK false
...
// CHECK_5: -t i8 -transQ false -transK false -transV false -transO false -causal false -return_lse false -split_kv 1 -num_heads_q 4 -num_heads_kv 2 -g 8 -seq_len_q 256 -seq_len_k 512 -head_dim_qk 64 -head_dim_v 32 -with-attn-scale false -with-attn-bias false -transBias false -supportsSplitK false
...
// CHECK_6: -t i8 -transQ false -transK false -transV false -transO false -causal false -return_lse false -split_kv 1 -num_heads_q 4 -num_heads_kv 2 -g 1 -seq_len_q 256 -seq_len_k 512 -head_dim_qk 64 -head_dim_v 32 -with-attn-scale false -with-attn-bias false -transBias false -supportsSplitK false
...
// CHECK_7: -t i8 -transQ false -transK false -transV false -transO false -causal false -return_lse false -split_kv 1 -num_heads_q 4 -num_heads_kv 2 -g 8 -seq_len_q 256 -seq_len_k 512 -head_dim_qk 64 -head_dim_v 32 -with-attn-scale false -with-attn-bias false -transBias false -supportsSplitK false
...
// CHECK_8: -t f16 -transQ false -transK false -transV false -transO false -causal true -return_lse false -split_kv 1 -num_heads_q 1 -num_heads_kv 1 -g 1 -seq_len_q 256 -seq_len_k 512 -head_dim_qk 64 -head_dim_v 32 -with-attn-scale false -with-attn-bias false -transBias false -supportsSplitK false
...
// CHECK_9: -t f16 -transQ false -transK false -transV false -transO false -causal false -return_lse true -split_kv 1 -num_heads_q 1 -num_heads_kv 1 -g 1 -seq_len_q 256 -seq_len_k 512 -head_dim_qk 64 -head_dim_v 32 -with-attn-scale false -with-attn-bias false -transBias false -supportsSplitK false
...
// CHECK_10: -t f16 -transQ false -transK false -transV false -transO false -causal false -return_lse true -split_kv 8 -num_heads_q 1 -num_heads_kv 1 -g 1 -seq_len_q 256 -seq_len_k 512 -head_dim_qk 64 -head_dim_v 32 -with-attn-scale false -with-attn-bias false -transBias false -supportsSplitK false
...
// CHECK_SCALE_BIAS: -t f32 -transQ false -transK false -transV false -transO false -causal false -return_lse false -split_kv 1 -num_heads_q 1 -num_heads_kv 1 -g 1 -seq_len_q 256 -seq_len_k 512 -head_dim_qk 64 -head_dim_v 32 -with-attn-scale true -with-attn-bias true -transBias false -supportsSplitK false
...
// CHECK_SCALE_ONLY: -head_dim_v 32 -with-attn-scale true -with-attn-bias false -transBias false -supportsSplitK false
...
// CHECK_BIAS_ONLY: -head_dim_v 32 -with-attn-scale false -with-attn-bias true -transBias false -supportsSplitK false
...
// CHECK_TRANS_BIAS: -head_dim_v 32 -with-attn-scale false -with-attn-bias true -transBias true -supportsSplitK false
...
// CHECK_I8_SCALE_BIAS: -t i8 {{.*}} -head_dim_v 32 -with-attn-scale true -with-attn-bias true -transBias false -supportsSplitK false
...
// CHECK_I8_NO_SCALE_BIAS: -t i8 {{.*}} -head_dim_v 32 -with-attn-scale false -with-attn-bias false -transBias false -supportsSplitK false
...
// CHECK_SW: -t f16 -transQ false -transK false -transV false -transO false -causal false -return_lse false -split_kv 1 -sliding_window_look_back 8 -num_heads_q 1 -num_heads_kv 1 -g 1 -seq_len_q 256 -seq_len_k 512 -head_dim_qk 64 -head_dim_v 32 {{.*}} -supportsSplitK false
...
// CHECK_SW_TRANSBIAS: -split_kv 1 -sliding_window_look_back 8 -num_heads_q 1 -num_heads_kv 1 -g 1 -seq_len_q 256 -seq_len_k 512 -head_dim_qk 64 -head_dim_v 32 -with-attn-scale false -with-attn-bias true -transBias true -supportsSplitK false
...
// RUN: rocmlir-gen --arch gfx942 --operation conv -t f16 --fil_layout gkc01 --in_layout ngc01 --out_layout ngk01 --batchsize 64 --in_channels 256 --in_h 20 --in_w 20 --out_channels 256 --fil_h 7 --fil_w 7 --dilation_h 1 --dilation_w 1 --conv_stride_h 1 --conv_stride_w 1 --padding_h 3 --padding_w 3 --groupsize 128 --perf_config=gemm:v1:32,256,8,1,1,4,32,1,2,0,0 | rocmlir-gen --emit-tuning-key - | FileCheck %s  --check-prefixes=CHECK_GROUP_CONV
// CHECK_GROUP_CONV: convfp16 -F 1 -f GNC01 -I NGC01 -O NGC01 -n 64 -c 256 -H 20 -W 20 -k 256 -y 7 -x 7 -p 3 -q 3 -u 1 -v 1 -l 1 -j 1 -g 128

// RUN: rocmlir-gen --arch gfx942 --operation conv -t f16 --fil_layout gkc01 --in_layout ngc01 --out_layout ngk01 --batchsize 64 --in_channels 256 --in_h 20 --in_w 20 --out_channels 512 --fil_h 7 --fil_w 7 --dilation_h 1 --dilation_w 1 --conv_stride_h 1 --conv_stride_w 1 --padding_h 3 --padding_w 3 --groupsize 128 --perf_config=gemm:v1:32,256,8,1,1,4,32,1,2,0,0 | rocmlir-gen --emit-tuning-key - | FileCheck %s  --check-prefixes=CHECK_GROUP_CONV2
...
// CHECK_NUMCU: 304{{.*}}-supportsSplitK false
...
// CHECK_SCALED_GEMM: -t f4E2M1FN -out_datatype f32 -transA false -transB true -transO false -scaledGemm -scale_a_dtype f8E8M0FNU -scale_b_dtype f8E8M0FNU -transScaleA false -transScaleB true -g 12 -m 256 -n 256 -k 64 -supportsSplitK true
...
// CHECK_GEMM_TRANSO: -t f32 -out_datatype f32 -transA false -transB false -transO true -g 1 -m 1024 -n 512 -k 769 -supportsSplitK true
...
// CHECK_GEMM_TRANSA_TRANSO: -t f32 -out_datatype f32 -transA true -transB false -transO true -g 1 -m 1024 -n 512 -k 769 -supportsSplitK true
...
// CHECK_GEMM_TRANSB_TRANSO: -t f32 -out_datatype f32 -transA false -transB true -transO true -g 1 -m 1024 -n 512 -k 769 -supportsSplitK true
...
// CHECK_GEMM_TRANSA_TRANSB_TRANSO: -t f32 -out_datatype f32 -transA true -transB true -transO true -g 1 -m 1024 -n 512 -k 769 -supportsSplitK true
...
// CHECK_NUMCHIPLETS: 80 4{{.*}}-supportsSplitK false
