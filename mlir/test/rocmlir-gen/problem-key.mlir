...
// CHECK_BIAS_ONLY: -head_dim_v 32 -with-attn-scale false -with-attn-bias true
...
// CHECK_I8_NO_SCALE_BIAS: -t i8 {{.*}} -head_dim_v 32 -with-attn-scale false -with-attn-bias false
