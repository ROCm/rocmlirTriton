...
//
// 2D tests (1-3) use the same convolution shape so the only variable is
// the operation type:
...
// ============================================================================
// (4) 3D forward convolution. K_eff = Cin * filD * filH * filW = 4*3*3*3 = 108.
...
// ============================================================================
// (5) 3D backward weight. K_eff = N * outD * outH * outW = 2*2*2*2 = 16.
// Verifies that the depth dimension is included in the bwd_weight K_eff.
// ============================================================================
