...
// Padding_One-NEXT: rock.conv([[exp0]], [[exp1]], [[exp2]]) {dilations = [1 : index, 1 : index], filter_layout = ["g", "k", "c", "0", "1"], input_layout = ["ni", "gi", "ci", "0i", "1i"], output_layout = ["no", "go", "ko", "0o", "1o"], padding = [0 : index, 0 : index, 1 : index, 2 : index], strides = [1 : index, 1 : index]} : tensor<1x256x32x1x1xf32>, tensor<32x1x32x14x14xf32>, tensor<32x1x256x14x17xf32>
...
// Padding_Two-NEXT: rock.conv([[exp0]], [[exp1]], [[exp2]]) {dilations = [1 : index, 1 : index], filter_layout = ["g", "k", "c", "0", "1"], input_layout = ["ni", "gi", "ci", "0i", "1i"], output_layout = ["no", "go", "ko", "0o", "1o"], padding = [3 : index, 3 : index, 1 : index, 2 : index], strides = [1 : index, 1 : index]} : tensor<1x256x32x1x1xf32>, tensor<32x1x32x14x14xf32>, tensor<32x1x256x20x17xf32>
