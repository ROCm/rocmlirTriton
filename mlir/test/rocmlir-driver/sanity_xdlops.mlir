...
// RUN: rocmlir-gen --arch gfx908 -p | rocmlir-driver -kernel-pipeline=gpu,rocdl --arch=gfx908 | rocmlir-opt
...
// RUN: rocmlir-gen --arch gfx908 -p -t f16 | rocmlir-driver -kernel-pipeline=gpu,rocdl --arch=gfx908 | rocmlir-opt
...
// RUN: rocmlir-gen --arch gfx908 -p -t bf16 | rocmlir-driver -kernel-pipeline=gpu,rocdl --arch=gfx908 | rocmlir-opt
...
// RUN: rocmlir-gen --arch gfx908 -p -t i8 | rocmlir-driver -kernel-pipeline=gpu,rocdl --arch=gfx908 | rocmlir-opt
