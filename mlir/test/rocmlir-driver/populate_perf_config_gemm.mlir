...
// RUN: rocmlir-gen --operation gemm -t f32 --arch gfx1030 -n 128 -k 8 -m 256 --perf_config "gemm:v1:128,64,64,1,1,4,16,1,2,0,0" | rocmlir-opt --rock-affix-params --rock-gemm-to-gridwise | FileCheck %s --check-prefix=GRIDWISE
...
// RUN: rocmlir-gen --operation gemm -t f32 --arch gfx1030 -n 128 -k 8 -m 256 --perf_config "gemm:v1:128,64,64,1,1,4,16,2,2,0,0" | rocmlir-opt --rock-affix-params --rock-gemm-to-gridwise | FileCheck %s --check-prefix=GRIDWISE_V2
