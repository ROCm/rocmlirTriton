...
// TRITON-NEXT:rock-bridge-vectorization-hints{phase=stash},
// TRITON-NEXT:tt.func(tritonamdgpu-canonicalize-pointers{enable-large-tensor-ptr-canon=false}),
// TRITON-NEXT:canonicalize{cse-between-iterations=false    max-iterations=10 max-num-rewrites=-1 region-simplify=normal test-convergence=false top-down=true},
// TRITON-NEXT:rock-bridge-vectorization-hints{phase=apply},
...
// TRITON_GFX1250-NEXT:rock-bridge-vectorization-hints{phase=stash},
// TRITON_GFX1250-NEXT:tt.func(tritonamdgpu-canonicalize-pointers{enable-large-tensor-ptr-canon=false}),
// TRITON_GFX1250-NEXT:canonicalize{cse-between-iterations=false    max-iterations=10 max-num-rewrites=-1 region-simplify=normal test-convergence=false top-down=true},
// TRITON_GFX1250-NEXT:rock-bridge-vectorization-hints{phase=apply},
...
// TRITON_RDNA-NEXT:rock-bridge-vectorization-hints{phase=stash},
// TRITON_RDNA-NEXT:tt.func(tritonamdgpu-canonicalize-pointers{enable-large-tensor-ptr-canon=false}),
// TRITON_RDNA-NEXT:canonicalize{cse-between-iterations=false    max-iterations=10 max-num-rewrites=-1 region-simplify=normal test-convergence=false top-down=true},
// TRITON_RDNA-NEXT:rock-bridge-vectorization-hints{phase=apply},
