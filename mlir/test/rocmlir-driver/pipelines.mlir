...
// TRITON-NEXT:rock-set-reduction-layout{num-stages=2 use-reduction-layout=-1},
...
// TRITON_GFX1250-NEXT:rock-set-reduction-layout{num-stages=2 use-reduction-layout=-1},
...
// TRITON_RDNA-NEXT:rock-set-reduction-layout{num-stages=2 use-reduction-layout=-1},
...
// BINARY-NEXT:triton-to-hsaco{allow-flush-denorm=true arch={{gfx90a|gfx942|gfx950}} enable-fp-fusion=true features= llvm-fn-attrs= max-live-values-per-block=0 num-ctas=1 num-warps=4 opt-level=3 scalarize-packed-fops=false triple=amdgcn-amd-amdhsa use-expert-scheduling=-1 waves-per-eu=0},
