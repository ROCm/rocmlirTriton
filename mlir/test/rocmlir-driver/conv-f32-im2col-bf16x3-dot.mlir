// RUN: sed s/##TOKEN_ARCH##/gfx1201/g %s | rocmlir-driver -kernel-pipeline=gpu --arch=gfx1201 - | FileCheck %s --check-prefix=BF16X3
// RUN: sed s/##TOKEN_ARCH##/gfx1250/g %s | rocmlir-driver -kernel-pipeline=gpu --arch=gfx1250 - | FileCheck %s --check-prefix=NATIVE
// RUN: sed s/##TOKEN_ARCH##/gfx942/g %s | rocmlir-driver -kernel-pipeline=gpu --arch=gfx942 - | FileCheck %s --check-prefix=NATIVE

// BF16X3-LABEL: tt.func @rock_conv_gkc01_ngc01_ngk01
// BF16X3: scf.for
// BF16X3: tt.dot {{.*}}, inputPrecision = bf16x3 {{.*}} tensor<64x32xf32> * tensor<32x64xf32> -> tensor<64x64xf32>

// NATIVE-LABEL: tt.func @rock_conv_gkc01_ngc01_ngk01
// NATIVE: scf.for
// NATIVE: tt.dot
// NATIVE-NOT: inputPrecision = bf16x3
// NATIVE-SAME: tensor<64x32xf32> * tensor<32x64xf32> -> tensor<64x64xf32>
...
module attributes {rock.arch = "amdgcn-amd-amdhsa:##TOKEN_ARCH##"} {
  func.func @rock_conv_gkc01_ngc01_ngk01(%arg0: tensor<73728xf32>, %arg1: tensor<8388608xf32>, %arg2: tensor<4194304xf32>) -> tensor<4194304xf32> attributes {rock.arch = "amdgcn-amd-amdhsa:##TOKEN_ARCH##", rock.enable_splitk_for_tuning, rock.kernel, rock.num_chiplets = 1 : i64, rock.num_cu = 64 : i32} {
