...
// RUN: rocmlir-gen --arch gfx1100 -p -t f16 | rocmlir-driver -kernel-pipeline=gpu,rocdl --arch=gfx1100 | rocmlir-opt
...
// RUN: rocmlir-gen --arch gfx1100 -p -t i8 | rocmlir-driver -kernel-pipeline=gpu,rocdl --arch=gfx1100 | rocmlir-opt
