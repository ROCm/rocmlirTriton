...
func.func private @rock_conv_g01kc_01ngc_01ngk(%arg0: tensor<9216xf32>, %arg1: tensor<1048576xf32>, %arg2: tensor<14745600xf32>) -> tensor<14745600xf32>

// HARNESS: module
// HARNESS: func @rock_conv_g01kc_01ngc_01ngk([[FILTER:%.*]]: tensor<9216xf32>, [[INPUT:%.*]]: tensor<1048576xf32>, [[OUTPUT:%.*]]: tensor<14745600xf32>) -> tensor<14745600xf32>
// LOWERING: module
...
func.func @main() {
  ...
  // launch kernel.
  %result_tensor = call @rock_conv_g01kc_01ngc_01ngk(%filter_tensor, %input_tensor, %output_tensor) : (tensor<9216xf32>, tensor<1048576xf32>, tensor<14745600xf32>) -> tensor<14745600xf32>
