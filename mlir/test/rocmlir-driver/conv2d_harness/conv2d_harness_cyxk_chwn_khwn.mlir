...
// HARNESS: module
// HARNESS: func @rock_conv_gc01k_gc01n_gk01n([[FILTER:%.*]]: tensor<9216xf32>, [[INPUT:%.*]]: tensor<1048576xf32>, [[OUTPUT:%.*]]: tensor<14745600xf32>) -> tensor<14745600xf32>
// LOWERING: module
...
func.func @main() {
  ...
  // launch kernel.
  %result_tensor = call @rock_conv_gc01k_gc01n_gk01n(%filter_tensor, %input_tensor, %output_tensor) : (tensor<9216xf32>, tensor<1048576xf32>, tensor<14745600xf32>) -> tensor<14745600xf32>
