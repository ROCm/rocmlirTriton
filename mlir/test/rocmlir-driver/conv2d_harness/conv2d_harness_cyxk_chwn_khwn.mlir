...
// RUN: rocmlir-gen --arch %arch -p -fil_layout=gcyxk -in_layout=gchwn -out_layout=gkhwn %s | rocmlir-driver -c | mlir-runner -O2 --shared-libs=%linalg_test_lib_dir/%shlibprefixmlir_rocm_runtime%shlibext,%conv_validation_wrapper_library_dir/%shlibprefixconv-validation-wrappers%shlibext,%linalg_test_lib_dir/%shlibprefixmlir_runner_utils%shlibext,%linalg_test_lib_dir/%shlibprefixmlir_float16_utils%shlibext --entry-point-result=void | FileCheck %s --check-prefix=E2E

func.func private @rock_conv_gc01k_gc01n_gk01n_0(%arg0: tensor<9216xf32>, %arg1: tensor<1048576xf32>, %arg2: tensor<14745600xf32>) -> tensor<14745600xf32>

// HARNESS: module
// HARNESS: func @rock_conv_gc01k_gc01n_gk01n_0([[FILTER:%.*]]: tensor<9216xf32>, [[INPUT:%.*]]: tensor<1048576xf32>, [[OUTPUT:%.*]]: tensor<14745600xf32>) -> tensor<14745600xf32>
// LOWERING: module
...
func.func @main() {
  ...
  // launch kernel.
  %result_tensor = call @rock_conv_gc01k_gc01n_gk01n_0(%filter_tensor, %input_tensor, %output_tensor) : (tensor<9216xf32>, tensor<1048576xf32>, tensor<14745600xf32>) -> tensor<14745600xf32>
