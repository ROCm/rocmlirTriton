...
// Padding_One-SAME: attributes {enable_splitk_for_tuning, kernel = 0 : i32, rock.arch = "{{.*}}", num_chiplets = {{.*}}, num_cu = {{.*}}}
...
// Padding_Two-SAME: attributes {enable_splitk_for_tuning, kernel = 0 : i32, rock.arch = "{{.*}}", num_chiplets = {{.*}}, num_cu = {{.*}}}
