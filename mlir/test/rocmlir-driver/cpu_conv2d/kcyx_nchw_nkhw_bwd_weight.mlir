...
// RUN: rocmlir-gen --arch %arch -prc -rand=none -fil_layout=kcyx -in_layout=nchw -out_layout=nkhw -batchsize=1 -in_channels=2 -out_channels=2 -in_h=8 -in_w=8 -fil_h=1 -fil_w=1 --dilation_h=1 --dilation_w=1 --padding_h=0 --padding_w=0 --conv_stride_h=1 --conv_stride_w=1 --operation=conv_bwd_weight | rocmlir-driver -host-pipeline=backend | rocm-run | FileCheck %s --check-prefix=CHECK1
...
// RUN: rocmlir-gen --arch %arch -prc -rand=none -fil_layout=kcyx -in_layout=nchw -out_layout=nkhw -batchsize=1 -in_channels=2 -out_channels=2 -in_h=8 -in_w=8 -fil_h=1 -fil_w=1 --dilation_h=1 --dilation_w=1 --padding_h=0 --padding_w=0 --conv_stride_h=2 --conv_stride_w=2 --operation=conv_bwd_weight | rocmlir-driver -host-pipeline=backend | rocm-run | FileCheck %s --check-prefix=CHECK5
...
// RUN: rocmlir-gen --arch %arch -prc -rand=none -fil_layout=kcyx -in_layout=nchw -out_layout=nkhw -batchsize=1 -in_channels=2 -out_channels=2 -in_h=8 -in_w=8 -fil_h=3 -fil_w=3 --dilation_h=1 --dilation_w=1 --padding_h=0 --padding_w=0 --conv_stride_h=1 --conv_stride_w=1 --operation=conv_bwd_weight | rocmlir-driver -host-pipeline=backend | rocm-run | FileCheck %s --check-prefix=CHECK9
...
// RUN: rocmlir-gen --arch %arch -prc -rand=none -fil_layout=kcyx -in_layout=nchw -out_layout=nkhw -batchsize=1 -in_channels=2 -out_channels=2 -in_h=8 -in_w=8 -fil_h=3 -fil_w=3 --dilation_h=1 --dilation_w=1 --padding_h=0 --padding_w=0 --conv_stride_h=2 --conv_stride_w=2 --operation=conv_bwd_weight | rocmlir-driver -host-pipeline=backend | rocm-run | FileCheck %s --check-prefix=CHECK13
