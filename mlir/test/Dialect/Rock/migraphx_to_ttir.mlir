...
// RUN: sed s/##TOKEN_ARCH##/%arch/g %s | rocmlir-driver -kernel-pipeline migraphx,highlevel -arch %arch |  rocmlir-driver -arch %arch -c --mlir-print-ir-after=rock-lower-blockwise-to-ptr -o /dev/null 2>&1 | FileCheck %s
