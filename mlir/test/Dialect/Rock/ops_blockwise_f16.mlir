...
func.func @rock_blockwise_gemm_f16(%A : tensor<8x128xf16>, %B : tensor<8x128xf16>, %C : tensor<8x8xf16>) -> tensor<8x8xf16> attributes {rock.arch = "amdgcn-amd-amdhsa:gfx942"} {
  %result = rock.blockwise_gemm(%A, %B, %C) {
    ...
    params = #rock.gemm_params<
      ...
      gridGroupSize = 0,
      numCTAs = 1>
  } : tensor<8x128xf16>, tensor<8x128xf16>, tensor<8x8xf16> -> tensor<8x8xf16>
