...
// RUN: | rocmlir-opt --rock-affix-params --rock-regularize-output --rock-conv-to-gemm --mlir-print-local-scope \
...
// FWD: <affine_map<(d0, d1, d2, d3, d4) -> (d1, d4, d2, d3, d0)> by
...
// WRW_ATOMIC: rock.store {{.*}} to {{.*}} by atomic_add
