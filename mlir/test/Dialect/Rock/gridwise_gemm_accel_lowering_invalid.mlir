...
// #xdlops_gemm_params_too_much_lds = #rock.gemm_params<kPerBlock = 32, mPerBlock = 256, nPerBlock = 256, kpack = 8, numWaves = 16, matrixInstrNonkdim = 32, splitKFactor = 1, numStages = 2, wavesPerEU = 0, gridGroupSize = 0, numCTAs = 1>
// func.func @excessive_lds_usage(%arg0: tensor<1x256x256xf32>, %arg1: tensor<1x256x256xf32>, %arg2: tensor<1x256x256xf32>) -> tensor<1x256x256xf32> attributes {block_size = 256 : i32, grid_size = 1 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx942", numCU = 304 : i32} {
...
// Format: A (G x K x M), B (G x K x N), C (G x M x N)
// #xdlops_gemm_params_gfx950_lds = #rock.gemm_params<kPerBlock = 16, mPerBlock = 512, nPerBlock = 512, kpack = 8, numWaves = 64, matrixInstrNonkdim = 32, splitKFactor = 1, numStages = 2, wavesPerEU = 0, gridGroupSize = 0, numCTAs = 1>
// func.func @gfx950_lds_exceeded(%arg0: tensor<1x128x512xf32>, %arg1: tensor<1x128x512xf32>, %arg2: tensor<1x512x512xf32>) -> tensor<1x512x512xf32> attributes {block_size = 256 : i32, grid_size = 1 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx950", numCU = 256 : i32} {
//   // expected-disabled-error @+2 {{requires too much LDS}}
//   // expected-disabled-error @+1 {{failed to legalize operation 'rock.gridwise_gemm'}}
...
// #xdlops_gemm_params_scaled_lds_exceeded = #rock.gemm_params<kPerBlock = 32, mPerBlock = 256, nPerBlock = 256, kpack = 32, numWaves = 64, matrixInstrNonkdim = 32, splitKFactor = 1, numStages = 2, wavesPerEU = 0, gridGroupSize = 0, numCTAs = 1>
// func.func @scaled_gemm_lds_exceeded(%arg0: tensor<1x1024x256xf4E2M1FN>, %arg1: tensor<1x1024x256xf4E2M1FN>, %arg2: tensor<1x256x256xf32>, %scaleA: tensor<1x1024x256xf8E8M0FNU>, %scaleB: tensor<1x1024x256xf8E8M0FNU>) -> tensor<1x256x256xf32> attributes {block_size = 256 : i32, grid_size = 1 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx950", numCU = 256 : i32} {
//   // expected-disabled-error @+2 {{requires too much LDS}}
//   // expected-disabled-error @+1 {{failed to legalize operation 'rock.gridwise_gemm'}}
...
// Format: A (G x K x M), B (G x K x N), C (G x M x N), scaleA (G x K x M), scaleB (G x K x N)
// #xdlops_gemm_params_scaled_lds_exceeded2 = #rock.gemm_params<kPerBlock = 32, mPerBlock = 512, nPerBlock = 512, kpack = 32, numWaves = 256, matrixInstrNonkdim = 32, splitKFactor = 1, numStages = 2, wavesPerEU = 0, gridGroupSize = 0, numCTAs = 1>
// func.func @scaled_gemm_lds_exceeded_alt(%arg0: tensor<1x1024x512xf4E2M1FN>, %arg1: tensor<1x1024x512xf4E2M1FN>, %arg2: tensor<1x512x512xf32>, %scaleA: tensor<1x1024x512xf8E8M0FNU>, %scaleB: tensor<1x1024x512xf8E8M0FNU>) -> tensor<1x512x512xf32> attributes {block_size = 256 : i32, grid_size = 1 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx950", numCU = 256 : i32} {
//   // expected-disabled-error @+2 {{requires too much LDS}}
//   // expected-disabled-error @+1 {{failed to legalize operation 'rock.gridwise_gemm'}}
