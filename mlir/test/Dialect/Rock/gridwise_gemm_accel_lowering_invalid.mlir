...
// #xdlops_gemm_params_too_much_lds = #rock.gemm_params<kPerBlock = 32, mPerBlock = 256, nPerBlock = 256, kpack = 8, numWaves = 16, matrixInstrNonkdim = 0, splitKFactor = 1, numStages = 2, wavesPerEU = 0, gridGroupSize = 0, numCTAs = 1>
...
// Format: A (G x K x M), B (G x K x N), C (G x M x N)
// #xdlops_gemm_params_gfx950_lds = #rock.gemm_params<kPerBlock = 16, mPerBlock = 512, nPerBlock = 512, kpack = 8, numWaves = 64, matrixInstrNonkdim = 0, splitKFactor = 1, numStages = 2, wavesPerEU = 0, gridGroupSize = 0, numCTAs = 1>
...
// #xdlops_gemm_params_scaled_lds_exceeded = #rock.gemm_params<kPerBlock = 32, mPerBlock = 256, nPerBlock = 256, kpack = 32, numWaves = 64, matrixInstrNonkdim = 0, splitKFactor = 1, numStages = 2, wavesPerEU = 0, gridGroupSize = 0, numCTAs = 1>
...
// Format: A (G x K x M), B (G x K x N), C (G x M x N), scaleA (G x K x M), scaleB (G x K x N)
// #xdlops_gemm_params_scaled_lds_exceeded2 = #rock.gemm_params<kPerBlock = 32, mPerBlock = 512, nPerBlock = 512, kpack = 32, numWaves = 256, matrixInstrNonkdim = 0, splitKFactor = 1, numStages = 2, wavesPerEU = 0, gridGroupSize = 0, numCTAs = 1>
