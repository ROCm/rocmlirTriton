...
func.func @rock_conv_gkc01_ngc01_ngk01(%arg0: tensor<73728xf32>, %arg1: tensor<1048576xf32>, %arg2: tensor<401408xf32>) -> tensor<401408xf32> attributes {rock.arch = "amdgcn-amd-amdhsa:gfx90a", rock.block_size = 256 : i32, rock.enable_splitk_for_tuning, rock.grid_size = 196 : i32, rock.kernel, rock.num_chiplets = 1 : i64, rock.num_cu = 104 : i32} {
  ...
  %2 = rock.transform %0 by <affine_map<(d0, d1, d2) -> (d0, d2, d1 floordiv 9, (d1 floordiv 3) mod 3, d1 mod 3)> by [<PassThrough ["gemmG"] at [0] -> ["g"] at [0]>, <Merge{128, 3, 3} ["gemmK"] at [1] -> ["c", "0", "1"] at [2, 3, 4]>, <PassThrough ["gemmM"] at [2] -> ["k"] at [1]>] bounds = [1, 1152, 64] -> [1, 64, 128, 3, 3]> : tensor<1x64x128x3x3xf32> to tensor<1x1152x64xf32>
  ...
  %6 = rock.transform %5 by <affine_map<(d0, d1, d2) -> (d2 floordiv 196, d0, d1 floordiv 9, (d1 floordiv 3) mod 3, (d2 floordiv 14) mod 14, d1 mod 3, d2 mod 14)> by [<PassThrough ["gemmG"] at [0] -> ["gi"] at [1]>, <Merge{128, 3, 3} ["gemmK"] at [1] -> ["ci", "0", "1"] at [2, 3, 5]>, <Merge{32, 14, 14} ["gemmN"] at [2] -> ["ni", "0o", "1o"] at [0, 4, 6]>] bounds = [1, 1152, 6272] -> [32, 1, 128, 3, 14, 3, 14]> : tensor<32x1x128x3x14x3x14xf32> to tensor<1x1152x6272xf32>
  ...
  %10 = rock.transform %9 by <affine_map<(d0, d1, d2) -> (d2 floordiv 196, d0, d1, (d2 floordiv 14) mod 14, d2 mod 14)> by [<PassThrough ["gemmG"] at [0] -> ["go"] at [1]>, <PassThrough ["gemmM"] at [1] -> ["ko"] at [2]>, <Merge{32, 14, 14} ["gemmN"] at [2] -> ["no", "0o", "1o"] at [0, 3, 4]>] bounds = [1, 64, 6272] -> [32, 1, 64, 14, 14]> : tensor<32x1x64x14x14xf32> to tensor<1x64x6272xf32>
