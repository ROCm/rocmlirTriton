// RUN: rocmlir-opt -split-input-file -rock-gridwise-gemm-to-blockwise -rock-decompose-nonpow2-k -canonicalize -verify-diagnostics %s | FileCheck %s
...
// CHECK-LABEL: @gemm_pow2_kperblock_no_decompose
...
func.func @gemm_pow2_kperblock_no_decompose(%arg0: tensor<1x64x128xf16>, %arg1: tensor<1x128x64xf16>, %arg2: tensor<1x64x64xf32>) -> tensor<1x64x64xf32> attributes {rock.block_size = 256 : i32, rock.grid_size = 1 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx942", rock.num_cu = 228 : i32, rock.kernel} {
