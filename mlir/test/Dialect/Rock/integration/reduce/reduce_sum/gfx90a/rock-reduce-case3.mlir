...
module {
  func.func private @zero_init(%arg0: memref<1x30x10xf32>) {
    %cst = arith.constant 0.000000e+00 : f32
    linalg.fill ins(%cst : f32) outs(%arg0 : memref<1x30x10xf32>)
    return
  }
  func.func private @test_reduce__part_1(%arg0: memref<20x30x10xf32>, %arg1: memref<1x30x10xf32>) {
  ...
  module @__xmodule_gfx90a attributes {rock.arch = "gfx90a", mhal.module} {
    func.func private @test_reduce__part_1(%arg0: memref<20x30x10xf32>, %arg1: memref<1x30x10xf32> {rock.prefill = 0.000000e+00 : f32}) attributes {kernel, original_func = @test_reduce__part_1, grid_size = 2, rock.block_size = 256} {
