...
// RUN:   | rocmlir-gen -ph -print-results -fut test_reduce --verifier clone -rand none -absDiff_threshold 0.01 - \
...
func.func @test_reduce(%arg0: tensor<1000x250x1xf32>, %arg1: tensor<1000x1x100xf32>) -> tensor<1x250x100xf32> attributes {rock.kernel, rock.arch = "##TOKEN_ARCH##"} {
  ...
  %gemm = "tosa.matmul"(%arg0, %arg1, %a_zp, %b_zp) : (tensor<1000x250x1xf32>, tensor<1000x1x100xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<1000x250x100xf32>
