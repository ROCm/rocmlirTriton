...
// RUN:   | rocmlir-gen -ph -print-results -fut test_reduce --verifier clone -rand 1 -rand_type float - \
...
func.func @test_reduce(%arg0: tensor<10x30x1xf32>, %arg1: tensor<10x1x20xf32>) -> tensor<10x1x20xf32> attributes {rock.kernel, rock.arch = "##TOKEN_ARCH##"} {
  ...
  %gemm = "tosa.matmul"(%arg0, %arg1, %a_zp, %b_zp) : (tensor<10x30x1xf32>, tensor<10x1x20xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<10x30x20xf32>
  %reduced = "tosa.reduce_max"(%gemm) {axis = 1 : i32} : (tensor<10x30x20xf32>) -> tensor<10x1x20xf32>
