...
func.func @rock_blockwise_fill_vec_case1(%output : memref<1x256xf32>) attributes{rock.arch = "##TOKEN_ARCH##", rock.block_size = 256 : i32, rock.grid_size = 1 : i32, rock.kernel} {
