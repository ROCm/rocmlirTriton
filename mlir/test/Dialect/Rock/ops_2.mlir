...
func.func @rock_blockwise_gemm(%A : tensor<8x128xf32>, %B : tensor<8x128xf32>, %C : tensor<8x8xf32>) -> tensor<8x8xf32> attributes {rock.arch = "amdgcn-amd-amdhsa:gfx90a"} {
  %result = rock.blockwise_gemm(%A, %B, %C) {
    ...
    params = #rock.gemm_params<
      ...
      gridGroupSize = 0,
      numCTAs = 1>
  } : tensor<8x128xf32>, tensor<8x128xf32>, tensor<8x8xf32> -> tensor<8x8xf32>
