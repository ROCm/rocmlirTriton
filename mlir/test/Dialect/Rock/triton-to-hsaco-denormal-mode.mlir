...
// is what the hardware actually runs with -- 0 flushes f32 denorms on input and
// output, 3 keeps them. The f16/f64 field beside it is a separate knob this
// option does not touch, which is why the checks name the _32 one.
