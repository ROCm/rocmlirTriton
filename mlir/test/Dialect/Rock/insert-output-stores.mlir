// RUN: rocmlir-opt -rock-insert-output-stores %s | FileCheck %s

// CHECK-LABEL: func.func @simple_gemm
// CHECK-SAME: (%arg0: tensor<8x16xf32>, %arg1: tensor<16x32xf32>, %arg2: tensor<8x32xf32>) attributes {rock.kernel}
// CHECK: %[[GEMM:.*]] = rock.gemm %arg0 * %arg1
// CHECK: rock.store %[[GEMM]] to %arg2 by set
// CHECK: return
...
// CHECK-SAME: (%arg0: tensor<8x16xf32>, %arg1: tensor<16x32xf32>, %arg2: tensor<8x32xf32>, %arg3: tensor<8x32xf32>) attributes {rock.kernel}
// CHECK: %[[GEMM:.*]] = rock.gemm %arg0 * %arg1
// CHECK: %[[ADD:.*]] = arith.addf %[[GEMM]], %arg2
// CHECK: rock.store %[[ADD]] to %arg3 by set
// CHECK: return
...
// CHECK-LABEL: func.func @gemm_linalg_fusion
// CHECK-SAME: (%arg0: tensor<8x16xf32>, %arg1: tensor<16x32xf32>, %arg2: tensor<8x32xf32>, %arg3: tensor<8x32xf32>) attributes {rock.kernel}
// CHECK: %[[GEMM:.*]] = rock.gemm %arg0 * %arg1
// CHECK: %[[GENERIC:.*]] = linalg.generic
// CHECK: rock.store %[[GENERIC]] to %arg3 by set
// CHECK: return
func.func @gemm_linalg_fusion(%arg0: tensor<8x16xf32>, %arg1: tensor<16x32xf32>, %arg2: tensor<8x32xf32>) -> tensor<8x32xf32> attributes {rock.kernel} {
  %0 = rock.gemm %arg0 * %arg1 : tensor<8x16xf32> * tensor<16x32xf32> -> tensor<8x32xf32>
  %empty = tensor.empty() : tensor<8x32xf32>
  %1 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel"]} ins(%0, %arg2 : tensor<8x32xf32>, tensor<8x32xf32>) outs(%empty : tensor<8x32xf32>) {
...
// Attention with two returns: both get stores, both returns removed
// CHECK-LABEL: func.func @attention_two_returns
// CHECK-SAME: (%arg0: tensor<1x32x32xf32>, %arg1: tensor<1x32x32xf32>, %arg2: tensor<1x32x32xf32>, %arg3: tensor<1x32x32xf32>, %arg4: tensor<1x32xf32>) attributes {rock.kernel}
// CHECK: %[[RESULT:.*]], %[[LSE:.*]] = rock.attention
// CHECK: rock.store %[[RESULT]] to %arg3 by set
// CHECK: rock.store %[[LSE]] to %arg4 by set
// CHECK: return
...
// Kernel with a caller: kernel return removed, caller uses tensor.empty
// CHECK-LABEL: func.func @kernel_with_caller
// CHECK-SAME: (%arg0: tensor<8x16xf32>, %arg1: tensor<16x32xf32>, %arg2: tensor<8x32xf32>) attributes {rock.kernel}
// CHECK: rock.gemm
// CHECK: rock.store
// CHECK: return
...
// CHECK: call @kernel_with_caller(%arg0, %arg1, %[[EMPTY]])
// CHECK: return %[[EMPTY]]
...
// Gemm -> transform -> return: new arg has transformed type, return removed
// CHECK-LABEL: func.func @gemm_with_transform
// CHECK-SAME: (%arg0: tensor<8x16xf32>, %arg1: tensor<16x32xf32>, %arg2: tensor<256xf32>) attributes {rock.kernel}
// CHECK: %[[GEMM:.*]] = rock.gemm
// CHECK: %[[TR:.*]] = rock.transform %[[GEMM]]
// CHECK: rock.store %[[TR]] to %arg2 by set
// CHECK: return
...
// CHECK-SAME: (%arg0: tensor<8x16xf32>, %arg1: tensor<16x32xf32>, %arg2: tensor<8x1xf32>) attributes {rock.kernel}
// CHECK: %[[GEMM:.*]] = rock.gemm
// CHECK: %[[RED:.*]] = rock.reduce sum %[[GEMM]]
// CHECK: rock.store %[[RED]] to %arg2 by set
// CHECK: return
...
// CHECK-SAME: (%arg0: tensor<1x32x32xf32>, %arg1: tensor<1x32x32xf32>, %arg2: tensor<1x32x32xf32>, %arg3: tensor<1024xf32>, %arg4: tensor<32xf32>) attributes {rock.kernel}
// CHECK: %[[RESULT:.*]], %[[LSE:.*]] = rock.attention
// CHECK: %[[TR_R:.*]] = rock.transform %[[RESULT]]
// CHECK: %[[TR_L:.*]] = rock.transform %[[LSE]]
// CHECK: rock.store %[[TR_R]] to %arg3 by set
// CHECK: rock.store %[[TR_L]] to %arg4 by set
// CHECK: return
...
// Mixed returns: gemm result stored (return removed), passthrough kept
...
// CHECK: %[[GEMM:.*]] = rock.gemm
// CHECK: rock.store %[[GEMM]] to %arg3 by set
// CHECK: return %arg2
