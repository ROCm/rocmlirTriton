...
#general_gemm_params0 = #rock.gemm_params<mPerBlock = 128, nPerBlock = 128, kPerBlock = 8, kpack = 1, numWaves = 1, matrixInstrNonkdim = 32, splitKFactor = 1, numStages = 2, wavesPerEU = 0, gridGroupSize = 0, numCTAs = 1>
#general_gemm_params_splitk = #rock.gemm_params<mPerBlock = 128, nPerBlock = 128, kPerBlock = 8, kpack = 1, numWaves = 1, matrixInstrNonkdim = 32, splitKFactor = 2, numStages = 2, wavesPerEU = 0, gridGroupSize = 0, numCTAs = 1>
#general_gemm_params1 = #rock.gemm_params<mPerBlock = 64, nPerBlock = 64, kPerBlock = 16, kpack = 1, numWaves = 1, matrixInstrNonkdim = 32, splitKFactor = 1, numStages = 2, wavesPerEU = 0, gridGroupSize = 0, numCTAs = 1>
...
#xdlops_gemm_params1 = #rock.gemm_params<mPerBlock = 128, nPerBlock = 128, kPerBlock = 4, kpack = 4, numWaves = 4, matrixInstrNonkdim = 32, splitKFactor = 1, numStages = 2, wavesPerEU = 0, gridGroupSize = 0, numCTAs = 1>
#xdlops_gemm_params3 = #rock.gemm_params<mPerBlock = 64, nPerBlock = 64, kPerBlock = 8, kpack = 1, numWaves = 2, matrixInstrNonkdim = 32, splitKFactor = 3, numStages = 2, wavesPerEU = 0, gridGroupSize = 0, numCTAs = 1>
#xldops_attn_params_g0 = #rock.gemm_params<mPerBlock = 32, nPerBlock = 32, kPerBlock = 1, kpack = 4, numWaves = 1, matrixInstrNonkdim = 32, splitKFactor = 1, numStages = 2, wavesPerEU = 0, gridGroupSize = 0, numCTAs = 1>
#xldops_attn_params_g1 = #rock.gemm_params<mPerBlock = 32, nPerBlock = 32, kPerBlock = 8, kpack = 4, numWaves = 1, matrixInstrNonkdim = 32, splitKFactor = 1, numStages = 2, wavesPerEU = 0, gridGroupSize = 0, numCTAs = 1>
#xldops_attn_params_g1_splitk = #rock.gemm_params<mPerBlock = 32, nPerBlock = 32, kPerBlock = 8, kpack = 4, numWaves = 1, matrixInstrNonkdim = 32, splitKFactor = 4, numStages = 2, wavesPerEU = 0, gridGroupSize = 0, numCTAs = 1>
...
// DISABLED-CHECK-SAME: block_size = 64 : i32, grid_size = 32 : i32
// func.func @rock_attention_simple(%arg0: tensor<1x64x1024xf32>, %arg1: tensor<1x64x1024xf32>, %arg2: tensor<1x1024x64xf32>, %arg3: tensor<1x1024x64xf32>) -> tensor<1x1024x64xf32> attributes {kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx908", block_size = 64 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx908"} {
...
// DISABLED-CHECK-SAME: block_size = 64 : i32, grid_size = 2 : i32
// func.func @rock_attention_tr_padded(%arg0: tensor<1x49x7xf32>, %arg1: tensor<1x7x49xf32>, %arg2: tensor<1x49x7xf32>, %arg3: tensor<1x49x7xf32>) -> tensor<1x49x7xf32> attributes {kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx908", block_size = 64 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx908"} {
...
// DISABLED-CHECK-SAME: block_size = 64 : i32, grid_size = 32 : i32
// func.func @rock_attention_kvcache(%arg0: tensor<1x64x1024xf32>, %arg1: tensor<1x64x1024xf32>, %arg2: tensor<1x1024x64xf32>, %arg3: tensor<1x1024x64xf32>, %arg4: tensor<1xi32>) -> tensor<1x1024x64xf32> attributes {kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx908", block_size = 64 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx908"} {
...
// DISABLED-CHECK-SAME: (%[[q:.*]]: tensor<1x64x1024xf32>, %[[k:.*]]: tensor<1x64x1024xf32>, %[[v:.*]]: tensor<1x1024x64xf32>, %[[o:.*]]: tensor<1x1024x64xf32>)
// DISABLED-CHECK-SAME: block_size = 64 : i32, grid_size = 32 : i32
// func.func @rock_attention_causal(%arg0: tensor<1x64x1024xf32>, %arg1: tensor<1x64x1024xf32>, %arg2: tensor<1x1024x64xf32>, %arg3: tensor<1x1024x64xf32>) -> tensor<1x1024x64xf32> attributes {kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx908", block_size = 64 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx908"} {
//   // DISABLED-CHECK: rock.gridwise_attention(%[[q]], %[[k]], %[[v]], %[[o]])
...
// DISABLED-CHECK-SAME: block_size = 64 : i32, grid_size = 32 : i32
// func.func @rock_attention_lse(%arg0: tensor<1x64x1024xf32>, %arg1: tensor<1x64x1024xf32>, %arg2: tensor<1x1024x64xf32>, %arg3: tensor<1x1024xf32>, %arg4: tensor<1x1024x64xf32>) -> tensor<1x1024x64xf32> attributes {kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx908", block_size = 64 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx908"} {
...
// DISABLED-CHECK-SAME: block_size = 64 : i32, grid_size = 32 : i32
// func.func @rock_attention_softmaxtype(%arg0: tensor<1x64x1024xf16>, %arg1: tensor<1x64x1024xf16>, %arg2: tensor<1x1024x64xf16>, %arg3: tensor<1x1024xf16>, %arg4: tensor<1x1024x64xf16>) -> tensor<1x1024x64xf16> attributes {kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx908", block_size = 64 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx908"} {
//   // DISABLED-CHECK: rock.gridwise_attention(%[[q]], %[[k]], %[[v]], %[[o]], %[[lse]])
...
// DISABLED-CHECK-SAME: block_size = 64 : i32, grid_size = 32 : i32
// func.func @rock_gemmelementwisegemm_simple(%arg0: tensor<1x64x1024xf32>, %arg1: tensor<1x64x1024xf32>, %arg2: tensor<1x1024x64xf32>, %arg3: tensor<1x1024x64xf32>) -> tensor<1x1024x64xf32> attributes {kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx908", block_size = 64 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx908"} {
...
// DISABLED-CHECK-SAME: block_size = 64 : i32, grid_size = 2 : i32
// func.func @rock_gemmelementwisegemm_tr_padded(%arg0: tensor<1x49x7xf32>, %arg1: tensor<1x7x49xf32>, %arg2: tensor<1x49x7xf32>, %arg3: tensor<1x49x7xf32>) -> tensor<1x49x7xf32> attributes {kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx908", block_size = 64 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx908"} {
...
// DISABLED-CHECK-SAME: block_size = 64 : i32, grid_size = 128 : i32
// func.func @rock_gemmelementwisegemm_splitk(%arg0: tensor<1x64x1024xf32>, %arg1: tensor<1x64x1024xf32>, %arg2: tensor<1x1024x64xf32>, %arg3: tensor<1x1024x64xf32>) -> tensor<1x1024x64xf32> attributes {kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx908", block_size = 64 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx908"} {
...
// DISABLED-CHECK-SAME: block_size = 64 : i32, grid_size = 8 : i32
// func.func @rock_gemmelementwisegemm_splitk_two_outputs(%arg0: tensor<4096xf32>, %arg1: tensor<4096xf32>, %arg2: tensor<4096xf32>, %arg3: tensor<4096xf32>, %arg4: tensor<64xf32>) -> (tensor<4096xf32>, tensor<64xf32>) attributes {kernel, mhal.arch = "amdgcn-amd-amdhsa:gfx908", block_size = 64 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx908"} {
...
//   } {firstGemmIndices = array<i64: 0>, params0 = #rock.gemm_params<mPerBlock = 64, nPerBlock = 32, kPerBlock = 16, kpack = 4, numWaves = 8, matrixInstrNonkdim = 16, splitKFactor = 1, numStages = 2, wavesPerEU = 0, gridGroupSize = 0, numCTAs = 1>, params1 = #rock.gemm_params<mPerBlock = 128, nPerBlock = 32, kPerBlock = 16, kpack = 4, numWaves = 8, matrixInstrNonkdim = 16, splitKFactor = 4, numStages = 2, wavesPerEU = 0, gridGroupSize = 0, numCTAs = 1>, perf_config = "attn:v2:64,128,32,16,32,16,4,4,1,2,1", storeMethod = #rock<StoreMethod set>} -> tensor<1x64x64xf32>
...
//   } {features = #rock<GemmFeatures wmma|dot|atomic_add|atomic_fmax_f32>, firstGemmIndices = array<i64: 0>, numHeadsKV = 8 : i32, numHeadsQ = 64 : i32, params0 = #rock.gemm_params<mPerBlock = 32, nPerBlock = 32, kPerBlock = 32, kpack = 1, numWaves = 1, matrixInstrNonkdim = 16, splitKFactor = 1, numStages = 2, wavesPerEU = 0, gridGroupSize = 0, numCTAs = 1>, params1 = #rock.gemm_params<mPerBlock = 32, nPerBlock = 32, kPerBlock = 32, kpack = 1, numWaves = 1, matrixInstrNonkdim = 16, splitKFactor = 1, numStages = 2, wavesPerEU = 0, gridGroupSize = 0, numCTAs = 1>, softmaxType = f32, splitKV = 4 : i32, storeMethod = #rock<StoreMethod set>} -> tensor<256x1x128xf16>
...
//     derivedBlockSize = 256 : i32,
//     gridSize = 16 : i32,
//     params = #rock.gemm_params<mPerBlock = 64, nPerBlock = 64, kPerBlock = 8, kpack = 1, numWaves = 4, matrixInstrNonkdim = 32, splitKFactor = 2, numStages = 2, wavesPerEU = 0, gridGroupSize = 0, numCTAs = 1>
//   } : tensor<1x72x128xf4E2M1FN> scaled by tensor<1x128x72xf8E8M0FNU> * tensor<1x72x512xf4E2M1FN> scaled by tensor<1x72x512xf8E8M0FNU> -> tensor<1x128x512xf32>
//   %out = rock.store %result to %c by set : tensor<1x128x512xf32> -> tensor<1x128x512xf32> to tensor<1x128x512xf32>
//   func.return %out : tensor<1x128x512xf32>
// }
...
//     derivedBlockSize = 256 : i32,
//     gridSize = 12 : i32,
//     params = #rock.gemm_params<mPerBlock = 64, nPerBlock = 64, kPerBlock = 16, kpack = 32, numWaves = 4, matrixInstrNonkdim = 32, splitKFactor = 5, numStages = 2, wavesPerEU = 0, gridGroupSize = 0, numCTAs = 1>
