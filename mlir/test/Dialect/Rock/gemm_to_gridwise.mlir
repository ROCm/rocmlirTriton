...
// func.func @rock_attention_simple(%arg0: tensor<1x64x1024xf32>, %arg1: tensor<1x64x1024xf32>, %arg2: tensor<1x1024x64xf32>, %arg3: tensor<1x1024x64xf32>) -> tensor<1x1024x64xf32> attributes {kernel, mhal.rock.arch = "amdgcn-amd-amdhsa:gfx908", rock.block_size = 64 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx908"} {
...
// func.func @rock_attention_tr_padded(%arg0: tensor<1x49x7xf32>, %arg1: tensor<1x7x49xf32>, %arg2: tensor<1x49x7xf32>, %arg3: tensor<1x49x7xf32>) -> tensor<1x49x7xf32> attributes {kernel, mhal.rock.arch = "amdgcn-amd-amdhsa:gfx908", rock.block_size = 64 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx908"} {
...
// DISABLED-CHECK-SAME: rock.block_size = 64 : i32, grid_size = 32 : i32
// func.func @rock_attention_kvcache(%arg0: tensor<1x64x1024xf32>, %arg1: tensor<1x64x1024xf32>, %arg2: tensor<1x1024x64xf32>, %arg3: tensor<1x1024x64xf32>, %arg4: tensor<1xi32>) -> tensor<1x1024x64xf32> attributes {kernel, mhal.rock.arch = "amdgcn-amd-amdhsa:gfx908", rock.block_size = 64 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx908"} {
...
// DISABLED-CHECK-SAME: (%[[q:.*]]: tensor<1x64x1024xf32>, %[[k:.*]]: tensor<1x64x1024xf32>, %[[v:.*]]: tensor<1x1024x64xf32>, %[[o:.*]]: tensor<1x1024x64xf32>)
// DISABLED-CHECK-SAME: rock.block_size = 64 : i32, grid_size = 32 : i32
// func.func @rock_attention_causal(%arg0: tensor<1x64x1024xf32>, %arg1: tensor<1x64x1024xf32>, %arg2: tensor<1x1024x64xf32>, %arg3: tensor<1x1024x64xf32>) -> tensor<1x1024x64xf32> attributes {kernel, mhal.rock.arch = "amdgcn-amd-amdhsa:gfx908", rock.block_size = 64 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx908"} {
//   // DISABLED-CHECK: rock.gridwise_attention(%[[q]], %[[k]], %[[v]], %[[o]])
...
// DISABLED-CHECK-SAME: rock.block_size = 64 : i32, grid_size = 32 : i32
// func.func @rock_attention_lse(%arg0: tensor<1x64x1024xf32>, %arg1: tensor<1x64x1024xf32>, %arg2: tensor<1x1024x64xf32>, %arg3: tensor<1x1024xf32>, %arg4: tensor<1x1024x64xf32>) -> tensor<1x1024x64xf32> attributes {kernel, mhal.rock.arch = "amdgcn-amd-amdhsa:gfx908", rock.block_size = 64 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx908"} {
...
// DISABLED-CHECK-SAME: rock.block_size = 64 : i32, grid_size = 32 : i32
// func.func @rock_attention_softmaxtype(%arg0: tensor<1x64x1024xf16>, %arg1: tensor<1x64x1024xf16>, %arg2: tensor<1x1024x64xf16>, %arg3: tensor<1x1024xf16>, %arg4: tensor<1x1024x64xf16>) -> tensor<1x1024x64xf16> attributes {kernel, mhal.rock.arch = "amdgcn-amd-amdhsa:gfx908", rock.block_size = 64 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx908"} {
//   // DISABLED-CHECK: rock.gridwise_attention(%[[q]], %[[k]], %[[v]], %[[o]], %[[lse]])
...
// DISABLED-CHECK-SAME: rock.block_size = 64 : i32, grid_size = 32 : i32
// func.func @rock_gemmelementwisegemm_simple(%arg0: tensor<1x64x1024xf32>, %arg1: tensor<1x64x1024xf32>, %arg2: tensor<1x1024x64xf32>, %arg3: tensor<1x1024x64xf32>) -> tensor<1x1024x64xf32> attributes {kernel, mhal.rock.arch = "amdgcn-amd-amdhsa:gfx908", rock.block_size = 64 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx908"} {
...
// DISABLED-CHECK-SAME: rock.block_size = 64 : i32, grid_size = 2 : i32
// func.func @rock_gemmelementwisegemm_tr_padded(%arg0: tensor<1x49x7xf32>, %arg1: tensor<1x7x49xf32>, %arg2: tensor<1x49x7xf32>, %arg3: tensor<1x49x7xf32>) -> tensor<1x49x7xf32> attributes {kernel, mhal.rock.arch = "amdgcn-amd-amdhsa:gfx908", rock.block_size = 64 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx908"} {
...
// func.func @rock_gemmelementwisegemm_splitk(%arg0: tensor<1x64x1024xf32>, %arg1: tensor<1x64x1024xf32>, %arg2: tensor<1x1024x64xf32>, %arg3: tensor<1x1024x64xf32>) -> tensor<1x1024x64xf32> attributes {kernel, mhal.rock.arch = "amdgcn-amd-amdhsa:gfx908", rock.block_size = 64 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx908"} {
...
// func.func @rock_gemmelementwisegemm_splitk_two_outputs(%arg0: tensor<4096xf32>, %arg1: tensor<4096xf32>, %arg2: tensor<4096xf32>, %arg3: tensor<4096xf32>, %arg4: tensor<64xf32>) -> (tensor<4096xf32>, tensor<64xf32>) attributes {kernel, mhal.rock.arch = "amdgcn-amd-amdhsa:gfx908", rock.block_size = 64 : i32, rock.arch = "amdgcn-amd-amdhsa:gfx908"} {
