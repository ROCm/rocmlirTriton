...
func.func @bwd_data_basic(%arg0: tensor<144xf32>, %arg1: tensor<288xf32>, %arg2: tensor<512xf32>) -> tensor<512xf32> attributes {rock.arch = "##TOKEN_ARCH##", rock.block_size = 128 : i32, rock.enable_splitk_for_tuning, rock.kernel = 0 : i32, rock.num_chiplets = 1 : i64, rock.num_cu = 2 : i32} {
...
// CHECK-NOT: rock.gemm
// CHECK-NOT: rock.store
func.func @bwd_data_padded(%arg0: tensor<144xf32>, %arg1: tensor<512xf32>, %arg2: tensor<512xf32>) -> tensor<512xf32> attributes {rock.arch = "##TOKEN_ARCH##", rock.block_size = 128 : i32, rock.enable_splitk_for_tuning, rock.kernel = 0 : i32, rock.num_chiplets = 1 : i64, rock.num_cu = 2 : i32} {
  %0 = rock.transform %arg0 by <affine_map<(d0, d1, d2, d3, d4) -> (((d1 * 4 + d2) * 3 + d3) * 3 + d4)> by [<Unmerge{4, 4, 3, 3} ["k", "c", "0", "1"] at [1, 2, 3, 4] -> ["raw"] at [0]>, <AddDim{1} ["g"] at [0] -> [] at []>] bounds = [1, 4, 4, 3, 3] -> [144]> : tensor<144xf32> to tensor<1x4x4x3x3xf32>
...
// CHECK-NOT: rock.gemm
// CHECK-NOT: rock.store
func.func @bwd_data_dilated(%arg0: tensor<144xf32>, %arg1: tensor<128xf32>, %arg2: tensor<512xf32> {rock.prefill = 0.000000e+00 : f32}) -> tensor<512xf32> attributes {rock.arch = "##TOKEN_ARCH##", rock.block_size = 128 : i32, rock.enable_splitk_for_tuning, rock.kernel = 0 : i32, rock.num_chiplets = 1 : i64, rock.num_cu = 2 : i32} {
  %0 = rock.transform %arg0 by <affine_map<(d0, d1, d2, d3, d4) -> (((d1 * 4 + d2) * 3 + d3) * 3 + d4)> by [<Unmerge{4, 4, 3, 3} ["k", "c", "0", "1"] at [1, 2, 3, 4] -> ["raw"] at [0]>, <AddDim{1} ["g"] at [0] -> [] at []>] bounds = [1, 4, 4, 3, 3] -> [144]> : tensor<144xf32> to tensor<1x4x4x3x3xf32>
...
// CHECK-NOT: rock.gemm
// CHECK-NOT: rock.store
func.func @bwd_data_strided_multi_kernel(%arg0: tensor<144xf32>, %arg1: tensor<72xf32>, %arg2: tensor<512xf32>) -> tensor<512xf32> attributes {rock.arch = "##TOKEN_ARCH##", rock.block_size = 128 : i32, rock.enable_splitk_for_tuning, rock.kernel = 0 : i32, rock.num_chiplets = 1 : i64, rock.num_cu = 2 : i32} {
  %0 = rock.transform %arg0 by <affine_map<(d0, d1, d2, d3, d4) -> (((d1 * 4 + d2) * 3 + d3) * 3 + d4)> by [<Unmerge{4, 4, 3, 3} ["k", "c", "0", "1"] at [1, 2, 3, 4] -> ["raw"] at [0]>, <AddDim{1} ["g"] at [0] -> [] at []>] bounds = [1, 4, 4, 3, 3] -> [144]> : tensor<144xf32> to tensor<1x4x4x3x3xf32>
...
func.func @bwd_weight_non_atomic(%arg0: tensor<512xf32>, %arg1: tensor<288xf32>, %arg2: tensor<144xf32>) -> tensor<144xf32> attributes {rock.arch = "amdgcn-amd-amdhsa:gfx1100", rock.block_size = 128 : i32, rock.enable_splitk_for_tuning, rock.kernel = 0 : i32, rock.num_chiplets = 1 : i64, rock.num_cu = 2 : i32} {
...
// CHECK-NOT: by set
func.func @bwd_weight_atomic(%arg0: tensor<1605632xf32>, %arg1: tensor<1179648xf32>, %arg2: tensor<36864xf32> {rock.prefill = 0.000000e+00 : f32}) -> tensor<36864xf32> attributes {rock.arch = "amdgcn-amd-amdhsa:gfx908", rock.block_size = 256 : i32, rock.enable_splitk_for_tuning, rock.kernel = 0 : i32, rock.num_chiplets = 1 : i64, rock.num_cu = 120 : i32} {
