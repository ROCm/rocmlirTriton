...
module {
  func.func @mlir_convolution(%arg0: memref<2x960x128x128xf16>, %arg1: memref<320x960x1x1xf16>, %arg2: memref<2x320x128x128xf16>) attributes {rock.arch = "gfx1100", rock.kernel = "mixr", num_cu = 48 : i64} {
    ...
    rock.conv(%1, %0, %2) {dilations = [1 : index, 1 : index], filter_layout = ["g", "k", "c", "y", "x"], input_layout = ["ni", "gi", "ci", "hi", "wi"], rock.numCU = 48 : i32, output_layout = ["no", "go", "ko", "ho", "wo"], padding = [0 : index, 0 : index, 0 : index, 0 : index], perf_config = "v3:256,128,4,4,128,16,1,1,2,1,1", strides = [1 : index, 1 : index]} : memref<1x320x960x1x1xf16>, memref<2x1x960x128x128xf16>, memref<2x1x320x128x128xf16>
