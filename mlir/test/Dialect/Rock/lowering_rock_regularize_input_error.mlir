...
// ============================================================
// Error: non-dense constant in fusion chain of load_marker source.
// ============================================================
...
module {
  func.func @error_non_dense_constant(%tile: tensor<2xf32>, %dest: tensor<1x2xf32>, %g: i32, %m: i32) -> tensor<1x2xf32> attributes {rock.kernel} {
    %sm = rock.store_marker %tile views [#tmap_small] [%g, %m] : tensor<2xf32> -> tensor<1x2xf32>
    // expected-error @below {{'arith.constant' op expected a dense tensor constant in fusion chain}}
    %cst = arith.constant sparse<[[0, 0], [0, 1]], [1.0, 2.0]> : tensor<1x2xf32>
