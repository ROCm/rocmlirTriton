...
// CHECK-SAME:  (%[[ARG0:.*]]: tensor<1728xf32> {mhal.read_access}, %[[ARG1:.*]]: tensor<1728xf32> {mhal.read_access}) -> (tensor<1728xf32> {mhal.write_access})
...
func.func @flatten_args_and_result(
    %arg0: tensor<1x12x12x12xf32> {mhal.read_access},
    %arg1: tensor<1x12x12x12xf32> {mhal.read_access})
    -> (tensor<1x12x12x12xf32> {mhal.write_access}) attributes {rock.kernel} {
...
// CHECK-SAME:  (%[[ARG0:.*]]: tensor<384xf32> {mhal.read_access}, %[[ARG1:.*]]: tensor<12xf32> {mhal.read_access}, %[[ARG2:.*]]: tensor<1xf32> {mhal.read_access}) -> (tensor<384xf32> {mhal.write_access}, tensor<12xf32> {mhal.write_access})
...
func.func @mixed_ranks(
    %arg0: tensor<12x32xf32> {mhal.read_access},
    %arg1: tensor<12xf32> {mhal.read_access},
    %arg2: tensor<1xf32> {mhal.read_access})
    -> (tensor<12x32xf32> {mhal.write_access}, tensor<12xf32> {mhal.write_access}) attributes {rock.kernel} {
...
// CHECK-SAME:  (%[[ARG0:.*]]: tensor<384xf32> {mhal.read_access}) -> (tensor<384xf32> {mhal.write_access}, tensor<384xf32> {mhal.write_access})
// CHECK:       tosa.reshape %[[ARG0]], %{{.*}} : (tensor<384xf32>, !tosa.shape<2>) -> tensor<12x32xf32>
...
func.func @multi_return(
    %arg0: tensor<12x32xf32> {mhal.read_access})
    -> (tensor<12x32xf32> {mhal.write_access}, tensor<12x32xf32> {mhal.write_access}) attributes {rock.kernel} {
