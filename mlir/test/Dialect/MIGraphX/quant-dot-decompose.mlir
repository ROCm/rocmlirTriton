...
func.func @quant_dot_with_both_scales_f8e8m0fnu(
  ...
  // CHECK: %[[DOT:.*]] = migraphx.dot %[[MUL_A]], %[[MUL_B]] {perf_config = "gemm:v1:64,64,512,1,1,4,32,4,2,0,0"} : <1x16x512xf32, 8192x512x1>, <1x512x16xf32, 8192x16x1> -> <1x16x16xf32, 256x16x1>
  // CHECK: return %[[DOT]]
  %0 = migraphx.quant_dot
       %arg0 scaled by %arg2,
       %arg1 scaled by %arg3 {perf_config = "gemm:v1:64,64,512,1,1,4,32,4,2,0,0"}
