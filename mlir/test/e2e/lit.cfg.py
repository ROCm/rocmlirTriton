...
# Generated E2E tests invoke the widget as a bare `rocm-run`; Windows can't
# execute the shebang bash script, so route it to the Python companion. The
# negative lookahead leaves `rocm-run.py` untouched.
