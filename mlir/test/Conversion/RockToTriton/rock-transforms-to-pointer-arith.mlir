...
//      CHECK:   rock.blockwise_load_tile_ptr {{.*}} : tensor<64x64xi32>, tensor<64x64xi1> -> tensor<64x64xf16>
...
func.func @test_transforms_to_ptr_load(%arg0: tensor<32768xf16>) -> tensor<64x64xf16> attributes {rock.arch = "##TOKEN_ARCH##"} {
  ...
  %2 = rock.blockwise_load_tile_ptr %pointers[%mask] : tensor<64x64xi32>, tensor<64x64xi1> -> tensor<64x64xf16>
...
func.func @test_transforms_to_ptr_store(%arg0: tensor<64x64xf32>, %arg1: tensor<8192xf32>) -> tensor<8192xf32> attributes {rock.arch = "##TOKEN_ARCH##"} {
  ...
  %2 = rock.blockwise_store_tile_ptr %arg0 -> %pointers(%mask) by set : tensor<64x64xf32> -> tensor<64x64xi32>(tensor<64x64xi1>) -> tensor<8192xf32>
...
func.func @test_extract_ptr_hoisting(%arg0: tensor<8192xf16>, %arg1: tensor<8192xf16>) -> tensor<64x64xf16> attributes {rock.arch = "##TOKEN_ARCH##"} {
  ...
  %2 = rock.blockwise_load_tile_ptr %pointers0[%mask0] : tensor<64x64xi32>, tensor<64x64xi1> -> tensor<64x64xf16>
  ...
  %5 = rock.blockwise_load_tile_ptr %pointers1[%mask1] : tensor<64x64xi32>, tensor<64x64xi1> -> tensor<64x64xf16>
...
//      CHECK:   rock.blockwise_load_tile_ptr {{.*}} : tensor<32x128xi32>, tensor<32x128xi1> -> tensor<32x128xf16>
//  CHECK-NOT:   rock.transforms_to_ptr
func.func @test_nonsquare_tile(%arg0: tensor<4096xf16>) -> tensor<32x128xf16> attributes {rock.arch = "##TOKEN_ARCH##"} {
  ...
  %1 = rock.blockwise_load_tile_ptr %pointers[%mask] : tensor<32x128xi32>, tensor<32x128xi1> -> tensor<32x128xf16>
...
func.func @test_insufficient_indices(%arg0: tensor<8192xf16>) -> tensor<64x64xf16> attributes {rock.arch = "##TOKEN_ARCH##"} {
  ...
  %1 = rock.blockwise_load_tile_ptr %pointers[%mask] : tensor<64x64xi32>, tensor<64x64xi1> -> tensor<64x64xf16>
