...
// CHECK-LABEL: @test_blockwise_load_tile
...
//      CHECK:   %[[RESULT:.*]] = rock.blockwise_load_tile_ptr %[[PTRS]][%[[MASK]]] : tensor<64x64xi32>, tensor<64x64xi1> -> tensor<64x64xf16>
//      CHECK:   return %[[RESULT]] : tensor<64x64xf16>
//  CHECK-NOT:   rock.blockwise_load_tile
//  CHECK-NOT:   rock.blockwise_store_tile
func.func @test_blockwise_load_tile(%arg0: tensor<32768xf16>) -> tensor<64x64xf16> attributes {rock.arch = "##TOKEN_ARCH##"} {
  %c0_i32 = arith.constant 0 : i32
  %c1_i32 = arith.constant 1 : i32

  // Transforms based similar to a GEMM lowering (for rock.blockwise_load_tile)
  ...
  %2 = rock.blockwise_load_tile %1[%c0_i32, %c0_i32, %c0_i32, %c1_i32] : tensor<4x1x1x2x64x64xf16> -> tensor<64x64xf16>
...
//      CHECK:   %[[RESULT:.*]] = rock.blockwise_store_tile_ptr %[[ARG0]] -> %[[PTRS]](%[[MASK]]) by  set : tensor<64x64xf32> -> tensor<64x64xi32>(tensor<64x64xi1>) -> tensor<8192xf32>
...
func.func @test_blockwise_store_tile(%arg0: tensor<64x64xf32>, %arg1: tensor<8192xf32>) -> tensor<8192xf32> attributes {rock.arch = "##TOKEN_ARCH##"} {
  ...
  // Transforms based similar to a GEMM lowering (for rock.blockwise_store_tile)
  ...
  %2 = rock.blockwise_store_tile %arg0 -> %1[%c0_i32, %c0_i32, %c1_i32] by set : tensor<64x64xf32> -> tensor<1x1x2x64x64xf32> -> tensor<8192xf32>
...
//       CHECK:   rock.blockwise_load_tile_ptr
//       CHECK:   %{{.*}}, %{{.*}} = rock.transforms_to_ptr %{{.*}} : tensor<1x2x64x64xf16> -> tensor<64x64xi32>, tensor<64x64xi1>
//       CHECK:   rock.blockwise_load_tile_ptr
//       CHECK:   %{{.*}}, %{{.*}} = rock.transforms_to_ptr %{{.*}} : tensor<64x64xf32> -> tensor<64x64xi32>, tensor<64x64xi1>
//       CHECK:   rock.blockwise_store_tile_ptr {{.*}} by  set
//   CHECK-NOT:   rock.blockwise_load_tile
//   CHECK-NOT:   rock.blockwise_store_tile
func.func @test_multiple_ops(%arg0: tensor<8192xf16>, %arg1: tensor<8192xf16>, %arg2: tensor<4096xf32>) -> tensor<4096xf32> attributes {rock.arch = "##TOKEN_ARCH##"} {
  %c0_i32 = arith.constant 0 : i32
  ...
  %2 = rock.blockwise_load_tile %1[%c0_i32, %c0_i32] : tensor<1x2x64x64xf16> -> tensor<64x64xf16>
  ...
  %5 = rock.blockwise_load_tile %4[%c0_i32, %c0_i32] : tensor<1x2x64x64xf16> -> tensor<64x64xf16>
  ...
  %8 = rock.blockwise_store_tile %6 -> %7 by set : tensor<64x64xf32> -> tensor<64x64xf32> -> tensor<4096xf32>
...
//      CHECK:   rock.blockwise_store_tile_ptr %[[ARG0]] -> %[[PTRS]](%[[MASK]]) by  atomic_add
//  CHECK-NOT:   rock.blockwise_store_tile
func.func @test_store_atomic_add(%arg0: tensor<64x64xf32>, %arg1: tensor<4096xf32>) -> tensor<4096xf32> attributes {rock.arch = "##TOKEN_ARCH##"} {
  %c0_i32 = arith.constant 0 : i32
  ...
  %1 = rock.blockwise_store_tile %arg0 -> %0 by atomic_add : tensor<64x64xf32> -> tensor<64x64xf32> -> tensor<4096xf32>
...
// CHECK-SAME: (%[[ARG0:.*]]: tensor<64x64xf32>, %[[ARG1:.*]]: tensor<4096xf32>)
//      CHECK:   rock.blockwise_store_tile_ptr {{.*}} by  atomic_max
//  CHECK-NOT:   rock.blockwise_store_tile
func.func @test_store_atomic_max(%arg0: tensor<64x64xf32>, %arg1: tensor<4096xf32>) -> tensor<4096xf32> attributes {rock.arch = "##TOKEN_ARCH##"} {
  %c0_i32 = arith.constant 0 : i32

  %0 = rock.transform %arg1 by <affine_map<(d0, d1) -> (d0 * 64 + d1)> by [<Unmerge{64, 64} ["m", "n"] at [0, 1] -> ["raw"] at [0]>] bounds = [64, 64] -> [4096]> : tensor<4096xf32> to tensor<64x64xf32>
  %1 = rock.blockwise_store_tile %arg0 -> %0 by atomic_max : tensor<64x64xf32> -> tensor<64x64xf32> -> tensor<4096xf32>
...
//      CHECK:   rock.blockwise_load_tile_ptr %[[PTRS]][%[[MASK]]] : tensor<64x64xi32>, tensor<64x64xi1> -> tensor<64x64xi8>
//  CHECK-NOT:   rock.blockwise_load_tile
func.func @test_load_i8(%arg0: tensor<4096xi8>) -> tensor<64x64xi8> attributes {rock.arch = "##TOKEN_ARCH##"} {
  ...
  %1 = rock.blockwise_load_tile %0[%c0_i32] : tensor<1x64x64xi8> -> tensor<64x64xi8>
...
//      CHECK:   rock.blockwise_load_tile_ptr %[[PTRS]][%[[MASK]]] : tensor<32x128xi32>, tensor<32x128xi1> -> tensor<32x128xf16>
//  CHECK-NOT:   rock.blockwise_load_tile
func.func @test_nonsquare_tile(%arg0: tensor<4096xf16>) -> tensor<32x128xf16> attributes {rock.arch = "##TOKEN_ARCH##"} {
  ...
  %1 = rock.blockwise_load_tile %0[%c0_i32] : tensor<1x32x128xf16> -> tensor<32x128xf16>
...
func.func @test_inside_scf_for(%arg0: tensor<8192xf16>) -> tensor<64x64xf16> attributes {rock.arch = "##TOKEN_ARCH##"} {
  ...
  %result = scf.for %i = %c0_i32 to %c2_i32 step %c1_i32 iter_args(%acc = %cst) -> tensor<64x64xf16> : i32 {
    %1 = rock.blockwise_load_tile %0[%i] : tensor<2x64x64xf16> -> tensor<64x64xf16>
...
// blockwise_load_tile without source indices
// CHECK-LABEL: @test_no_indices
// CHECK-SAME: (%[[ARG0:.*]]: tensor<4096xf16>)
//      CHECK:   %[[PTRS:.*]], %[[MASK:.*]] = rock.transforms_to_ptr %{{.*}} : tensor<64x64xf16> -> tensor<64x64xi32>, tensor<64x64xi1>
//      CHECK:   rock.blockwise_load_tile_ptr %[[PTRS]][%[[MASK]]] : tensor<64x64xi32>, tensor<64x64xi1> -> tensor<64x64xf16>
//  CHECK-NOT:   rock.blockwise_load_tile
func.func @test_no_indices(%arg0: tensor<4096xf16>) -> tensor<64x64xf16> attributes {rock.arch = "##TOKEN_ARCH##"} {
  ...
  %1 = rock.blockwise_load_tile %0 : tensor<64x64xf16> -> tensor<64x64xf16>
...
// CHECK-SAME: (%[[ARG0:.*]]: tensor<64x64xf32>, %[[ARG1:.*]]: tensor<4096xf32>)
//      CHECK:   %[[PTRS:.*]], %[[MASK:.*]] = rock.transforms_to_ptr %{{.*}} : tensor<64x64xf32> -> tensor<64x64xi32>, tensor<64x64xi1>
//      CHECK:   rock.blockwise_store_tile_ptr %[[ARG0]] -> %[[PTRS]](%[[MASK]]) by  set
//  CHECK-NOT:   rock.blockwise_store_tile
func.func @test_store_no_indices(%arg0: tensor<64x64xf32>, %arg1: tensor<4096xf32>) -> tensor<4096xf32> attributes {rock.arch = "##TOKEN_ARCH##"} {
  %0 = rock.transform %arg1 by <affine_map<(d0, d1) -> (d0 * 64 + d1)> by [<Unmerge{64, 64} ["m", "n"] at [0, 1] -> ["raw"] at [0]>] bounds = [64, 64] -> [4096]> : tensor<4096xf32> to tensor<64x64xf32>
  %1 = rock.blockwise_store_tile %arg0 -> %0 by set : tensor<64x64xf32> -> tensor<64x64xf32> -> tensor<4096xf32>
