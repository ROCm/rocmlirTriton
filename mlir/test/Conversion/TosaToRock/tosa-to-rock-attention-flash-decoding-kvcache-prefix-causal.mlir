...
// Ported from rocMLIR. Both per-batch block arguments are broadcast across
// batch * numHeads * splitKV here, so they reach rock.attention with 8 = 2 * 2
// * 2 entries. splitKV stays 1 at this stage; DetectFlashDecoding promotes it
// later and slices both tensors back down.
...
// CHECK-NEXT: causal
// CHECK: splitKV = 1 : i32} -> tensor<8x2x2xf16>, tensor<8x2xf32>
