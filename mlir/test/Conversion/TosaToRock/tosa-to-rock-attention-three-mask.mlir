...
// Exercises the iterative multi-mask walk in TosaToRock: three separately
...
//   3. sliding window   (column index vs. lastValidKVIndex - window)   -> arg4
// lastValidKVIndex, prefixOffset, causal, and slidingWindowLookBack must all survive.
...
module {
  func.func @attention_three_mask(%arg0: tensor<1xi32>, %arg1: tensor<9216xf16>, %arg2: tensor<2048xf16>, %arg3: tensor<2048xf16>, %arg4: tensor<2xi32>) -> (tensor<7168xf16>) attributes {rock.kernel} {
    ...
    // Negative window offset (-slidingWindowLookBack) for the sliding-window mask.
    ...
    // Sliding-window mask: greater(lastValidKVIndex - window, columnIndex).
