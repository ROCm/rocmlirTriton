...
func.func @self_attention_with_scale_and_bias(%arg0: tensor<1x384x64xf32>, %arg1: tensor<1x384x64xf32>, %arg2: tensor<1x384x64xf32>, %arg3: tensor<1x384x384xf32>, %arg4: tensor<1x384x384xf32>) -> tensor<1x384x64xf32> attributes {rock.kernel, rock.arch = "##TOKEN_ARCH##"} {
  ...
  %10 = "tosa.matmul"(%9, %arg2, %a_zp, %b_zp) {acc_type = f32} : (tensor<1x384x384xf32>, tensor<1x384x64xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<1x384x64xf32>
...
// CHECK: rock.attention
func.func @self_attention_with_4d_scale(%arg0: tensor<1x12x256x256xf32> , %arg1: tensor<1x12x256x256xf32>, %arg2: tensor<1x12x256x256xf32>, %arg3: tensor<1x12x256x256xf32>) -> (tensor<1x12x256x256xf32>) attributes {rock.kernel, rock.arch = "amdgcn-amd-amdhsa:gfx90a:sramecc+:xnack-"} {
...
func.func @self_attention_with_dot_product(%arg0: tensor<1x1x64xf32>, %arg1: tensor<1x1x64xf32>, %arg2: tensor<1x1x64xf32>, %arg3: tensor<1x1x1xf32>, %arg4: tensor<1x1x1xf32>) -> tensor<1x1x64xf32> attributes {rock.kernel, rock.arch = "##TOKEN_ARCH##"} {
  ...
  %8 = "tosa.matmul"(%7, %arg2, %a_zp, %b_zp) {acc_type = f32} : (tensor<1x1x1xf32>, tensor<1x1x64xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<1x1x64xf32>
  return %8 : tensor<1x1x64xf32>
}

// CHECK: rock.attention
// The input-only cast(%arg2) is hoisted out of the pre-softmax region and fused
// as an external input, so it enters the region already cast to i1.
...
// CHECK: rock.attention
// CHECK: perf_config = "sentinel-propagation-only"
