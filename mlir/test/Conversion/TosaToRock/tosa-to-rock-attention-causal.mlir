...
func.func @mlir_nokvcache_causal_attention(%arg0: tensor<24576xf16>, %arg1: tensor<262144xf16>, %arg2: tensor<262144xf16>) -> tensor<8192xf16> attributes {rock.kernel, rock.arch = "##TOKEN_ARCH##"} {
  ...
  %10 = tosa.matmul %collapsed, %collapsed_3, %a_zp, %b_zp {acc_type = f32} : (tensor<32x2x128xf16>, tensor<32x128x64xf16>, tensor<1xf16>, tensor<1xf16>) -> tensor<32x2x64xf16>
  ...
  %34 = tosa.matmul %collapsed_8, %expanded_9, %a_zp, %b_zp {acc_type = f32} : (tensor<32x2x64xf16>, tensor<32x64x128xf16>, tensor<1xf16>, tensor<1xf16>) -> tensor<32x2x128xf16>
...
func.func @mlir_causal_attention2(%arg0: tensor<24576xf16>, %arg1: tensor<262144xf16>, %arg2: tensor<262144xf16>, %arg3: tensor<1xi32>) -> tensor<8192xf16> attributes {rock.kernel, rock.arch = "##TOKEN_ARCH##"} {
  ...
  %a_zp = "tosa.const"() <{values = dense<0.0> : tensor<1xf16>}> : () -> tensor<1xf16>
  %b_zp = "tosa.const"() <{values = dense<0.0> : tensor<1xf16>}> : () -> tensor<1xf16>
  %9 = tosa.matmul %collapsed, %collapsed_3, %a_zp, %b_zp {acc_type = f32} : (tensor<32x2x128xf16>, tensor<32x128x64xf16>, tensor<1xf16>, tensor<1xf16>) -> tensor<32x2x64xf16>
  ...
  %30 = tosa.matmul %collapsed_6, %expanded_7, %a_zp, %b_zp {acc_type = f32} : (tensor<32x2x64xf16>, tensor<32x64x128xf16>, tensor<1xf16>, tensor<1xf16>) -> tensor<32x2x128xf16>
...
// CHECK: currentSeqLen = (%{{.*}} : tensor<32xi32>)
// CHECK: causal
func.func @mlir_causal_attention_hardcoded_causal_mask(%arg0: tensor<49152xf16>, %arg1: tensor<1048576xf16>, %arg2: tensor<1xi32>, %arg3: tensor<1048576xf16>) -> (tensor<16384xf16>) attributes {rock.arch = "gfx942",rock.kernel} {
...
// CHECK: currentSeqLen = (%{{.*}} : tensor<32xi32>)
// CHECK: causal
func.func @mlir_causal_attention_hardcoded_causal_mask2(%arg0: tensor<1xi32>, %arg1: tensor<49152xf16>, %arg2: tensor<1048576xf16>, %arg3: tensor<1048576xf16>) -> (tensor<16384xf16>) attributes {rock.kernel} {
  %0 = "tosa.const"() <{values = dense<""> : tensor<1x1x4x256xi8>}> : () -> tensor<1x1x4x256xi8>
  %1 = "tosa.const"() <{values = dense<""> : tensor<1x1x1x256xi32>}> : () -> tensor<1x1x1x256xi32>
  %2 = tosa.const_shape  {values = dense<16384> : tensor<1xindex>} : () -> !tosa.shape<1>
  %3 = tosa.const_shape  {values = dense<[32, 256, 128]> : tensor<3xindex>} : () -> !tosa.shape<3>
