...
module attributes {kernel.module, rock.arch = "amdgcn-amd-amdhsa:gfx906"} {
// CHECK-LABEL: @test_basic
// CHECK-SAME: -> (tensor<2x10x1xf32> {read_access, rock.prefill = 0.000000e+00 : f32})
...
// CHECK-SAME: -> (tensor<2x10x1xf16> {read_access, rock.prefill = 0.000000e+00 : f16})
...
// CHECK-SAME: -> (tensor<2x10x1xbf16> {read_access, rock.prefill = 0.000000e+00 : bf16})
...
// CHECK-SAME: -> (tensor<4x1x20xf32> {read_access, rock.prefill = 0.000000e+00 : f32})
...
// CHECK-SAME: -> (tensor<2x10x1xf32> {read_access, rock.prefill = 0xFF800000 : f32})
...
// CHECK-SAME: -> (tensor<2x10x1xf32> {read_access, rock.prefill = 0xFF800000 : f32}
// CHECK-SAME: , tensor<2x1x100xf32> {read_access, rock.prefill = 0xFF800000 : f32})
...
// CHECK-SAME: -> (tensor<2x10x1xf32> {read_access, rock.prefill = 0.000000e+00 : f32}
// CHECK-SAME: , tensor<2x1x100xf32> {read_access, rock.prefill = 0.000000e+00 : f32})
