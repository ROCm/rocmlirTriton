...
func.func @mlir_reshape_transpose_reshape_convolution(%arg0: tensor<1x116x28x28xf32>, %arg1: tensor<116x1x3x3xf32>) -> tensor<1x116x14x14xf32> attributes {rock.arch = "gfx1100", rock.kernel = "mixr"} {
  ...
  %6 = "tosa.conv2d"(%3, %4, %5, %input_zp, %weight_zp) {acc_type = f32, dilation = array<i64: 1, 1>, group = 116 : i64, pad = array<i64: 1, 0, 1, 0>, stride = array<i64: 2, 2>} : (tensor<1x28x28x116xf32>, tensor<116x3x3x1xf32>, tensor<116xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<1x14x14x116xf32>
