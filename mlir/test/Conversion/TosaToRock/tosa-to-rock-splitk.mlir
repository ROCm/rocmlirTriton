...
func.func @test_conv_gemm(%arg0: tensor<2048xf32>, %arg1: tensor<2304xf32>, %arg2: tensor<16xf32>) -> (tensor<4096xf32>) attributes {rock.kernel, rock.arch = "amdgcn-amd-amdhsa:gfx950"} {
  ...
  // CHECK: perf_config = "attn:v1:64,128,32,16,32,16,4,4,1,2,1"
  %18 = tosa.matmul %expanded_2, %9, %3, %3 {acc_type = f32, perf_config = "attn:v1:64,128,32,16,32,16,4,4,1,2,1"} : (tensor<1x128x16xf32>, tensor<1x16x32xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<1x128x32xf32>
