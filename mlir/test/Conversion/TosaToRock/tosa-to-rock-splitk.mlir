...
module attributes {kernel.module, rock.arch = "amdgcn-amd-amdhsa:gfx950"} {
// CHECK-LABEL: @test_basic
// CHECK-SAME: -> (tensor<2x128x256xf32> {read_access, rock.prefill = 0.000000e+00 : f32})
...
// CHECK-SAME: -> (tensor<2x128x256xf16> {read_access, rock.prefill = 0.000000e+00 : f16})
...
// CHECK-SAME: -> (tensor<2x128x256xbf16> {read_access, rock.prefill = 0.000000e+00 : bf16})
...
// CHECK-SAME: -> (tensor<2x128x1xf32> {read_access, rock.prefill = 0.000000e+00 : f32})
...
// CHECK-SAME: -> (tensor<2x128x1xf32> {read_access, rock.prefill = 0.000000e+00 : f32}
// CHECK-SAME: tensor<2x1x256xf32> {read_access, rock.prefill = 0.000000e+00 : f32})
...
// CHECK-SAME: -> (tensor<64xf16> {read_access, rock.prefill = 0.000000e+00 : f16}
// CHECK-SAME: tensor<2621440xf16> {read_access, rock.prefill = 0.000000e+00 : f16})
...
// CHECK-SAME: -> (tensor<4096xf32> {read_access, rock.prefill = 0.000000e+00 : f32})
...
// CHECK-SAME: -> (tensor<524288xf32> {read_access, rock.prefill = 0.000000e+00 : f32})
