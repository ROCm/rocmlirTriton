...
func.func @migraphx_div_si32(%arg0: !migraphx.shaped<1x36x384x64xsi32, 884736x24576x64x1>, %arg1: !migraphx.shaped<1x36x384x64xsi32, 884736x24576x64x1>) -> !migraphx.shaped<1x36x384x64xsi32, 884736x24576x64x1> attributes{rock.kernel, rock.arch = "gfx908"} {
...
func.func @migraphx_div_ui32(%arg0: !migraphx.shaped<1x36x384x64xui32, 884736x24576x64x1>, %arg1: !migraphx.shaped<1x36x384x64xui32, 884736x24576x64x1>) -> !migraphx.shaped<1x36x384x64xui32, 884736x24576x64x1> attributes{rock.kernel, rock.arch = "gfx908"} {
...
// CHECK: tosa.mul
// CHECK: tosa.custom{{.*}}"fp_to_int_cast"{{.*}}: (tensor<1x112x112x64xf32>) -> tensor<1x112x112x64xi32>
// CHECK: tosa.add
...
// CHECK: tosa.mul{{.*}}(tensor<1x64x112x112xf32>, tensor<1x64x1x1xf32>, tensor<1xi8>) -> tensor<1x64x112x112xf32>
// CHECK: tosa.custom{{.*}}"fp_to_int_cast"{{.*}}(tensor<1x64x112x112xf32>) -> tensor<1x64x112x112xi32>
