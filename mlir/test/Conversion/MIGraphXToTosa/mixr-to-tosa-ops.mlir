...
module  {
  ...
  // CHECK-SAME: {acc_type = f32}
  // CHECK: tosa.mul
  func.func @func_dot_mul(%arg0: !migraphx.shaped<1x5x4xf32, 20x4x1>, %arg1: !migraphx.shaped<1x4x3xf32, 12x3x1>, %arg2: !migraphx.shaped<1x5x3xf32, 15x3x1>) -> !migraphx.shaped<1x5x3xf32, 15x3x1> attributes{rock.kernel, rock.arch = "gfx908"} {
  ...
  // CHECK: tosa.slice
  func.func @func_slice1(%arg0: !migraphx.shaped<1x36x384x64xf32, 884736x24576x64x1>) -> !migraphx.shaped<1x12x384x64xf32, 294912x24576x64x1> attributes{rock.kernel, rock.arch = "gfx908"} {
  ...
  // CHECK: tosa.slice
  func.func @func_slice2(%arg0: !migraphx.shaped<1x36x384x64xf32, 884736x24576x64x1>) -> !migraphx.shaped<1x12x100x64xf32, 76800x6400x64x1> attributes{rock.kernel, rock.arch = "gfx908"} {
  ...
  func.func @func_greater(%arg0: !migraphx.shaped<1x36x384x64xi32, 884736x24576x64x1>) -> !migraphx.shaped<1x36x384x64xi32, 884736x24576x64x1> attributes{rock.kernel, rock.arch = "gfx908"} {
  ...
  // CHECK: %[[ge:.+]] = tosa.greater {{.*}} : (tensor<1x36x384x64xi32>, tensor<1x36x384x64xi32>) -> tensor<1x36x384x64xi1>
  // CHECK-NEXT: tosa.cast %[[ge]] : (tensor<1x36x384x64xi1>) -> tensor<1x36x384x64xi32>
  func.func @func_greater_si32(%arg0: !migraphx.shaped<1x36x384x64xsi32, 884736x24576x64x1>) -> !migraphx.shaped<1x36x384x64xsi32, 884736x24576x64x1> attributes{rock.kernel, rock.arch = "gfx908"} {
  ...
  func.func @func_equal(%arg0: !migraphx.shaped<1x36x384x64xi32, 884736x24576x64x1>) -> !migraphx.shaped<1x36x384x64xi32, 884736x24576x64x1> attributes{rock.kernel, rock.arch = "gfx908"} {
    %cst = migraphx.literal (dense<1> : tensor<1x36x384x64xi32>) : <1x36x384x64xi32, 884736x24576x64x1>
    %0 = migraphx.add %arg0, %cst : <1x36x384x64xi32, 884736x24576x64x1>, <1x36x384x64xi32, 884736x24576x64x1> -> <1x36x384x64xi32, 884736x24576x64x1>
  ...
  // CHECK: %[[eq:.+]] = tosa.equal {{.*}} : (tensor<1x36x384x64xi32>, tensor<1x36x384x64xi32>) -> tensor<1x36x384x64xi1>
  // CHECK-NEXT: tosa.cast %[[eq]] : (tensor<1x36x384x64xi1>) -> tensor<1x36x384x64xi32>
  func.func @func_equal_si32(%arg0: !migraphx.shaped<1x36x384x64xsi32, 884736x24576x64x1>) -> !migraphx.shaped<1x36x384x64xsi32, 884736x24576x64x1> attributes{rock.kernel, rock.arch = "gfx908"} {
    %cst = migraphx.literal (dense<1> : tensor<1x36x384x64xsi32>) : <1x36x384x64xsi32, 884736x24576x64x1>
    %0 = migraphx.add %arg0, %cst : <1x36x384x64xsi32, 884736x24576x64x1>, <1x36x384x64xsi32, 884736x24576x64x1> -> <1x36x384x64xsi32, 884736x24576x64x1>
...
module {
  ...
  // CHECK: tosa.reciprocal
  // CHECK: tosa.mul
  func.func @func_div_f32(%arg0: !migraphx.shaped<1x36x384x64xf32, 884736x24576x64x1>, %arg1: !migraphx.shaped<1x36x384x64xf32, 884736x24576x64x1>) -> !migraphx.shaped<1x36x384x64xf32, 884736x24576x64x1> attributes{rock.kernel, rock.arch = "gfx908"} {
  ...
  // CHECK: tosa.reciprocal
  // CHECK: tosa.mul
  func.func @func_div_f16(%arg0: !migraphx.shaped<1x36x384x64xf16, 884736x24576x64x1>, %arg1: !migraphx.shaped<1x36x384x64xf16, 884736x24576x64x1>) -> !migraphx.shaped<1x36x384x64xf16, 884736x24576x64x1> attributes{rock.kernel, rock.arch = "gfx908"} {
  ...
  // CHECK: tosa.intdiv
  func.func @func_div_i32(%arg0: !migraphx.shaped<1x36x384x64xi32, 884736x24576x64x1>, %arg1: !migraphx.shaped<1x36x384x64xi32, 884736x24576x64x1>) -> !migraphx.shaped<1x36x384x64xi32, 884736x24576x64x1> attributes{rock.kernel, rock.arch = "gfx908"} {
  ...
  // CHECK: tosa.erf
  func.func @func_erf_f32(%arg0: !migraphx.shaped<1x36x384x64xf32, 884736x24576x64x1>) -> !migraphx.shaped<1x36x384x64xf32, 884736x24576x64x1> attributes{rock.kernel, rock.arch = "gfx908"} {
  ...
  // CHECK: tosa.erf
  func.func @func_erf_f16(%arg0: !migraphx.shaped<1x36x384x64xf16, 884736x24576x64x1>) -> !migraphx.shaped<1x36x384x64xf16, 884736x24576x64x1> attributes{rock.kernel, rock.arch = "gfx908"} {
  ...
  // CHECK: tosa.exp
  func.func @func_exp_f32(%arg0: !migraphx.shaped<1x36x384x64xf32, 884736x24576x64x1>) -> !migraphx.shaped<1x36x384x64xf32, 884736x24576x64x1> attributes{rock.kernel, rock.arch = "gfx908"} {
  ...
  // CHECK: tosa.exp
  func.func @func_exp_f16(%arg0: !migraphx.shaped<1x36x384x64xf16, 884736x24576x64x1>) -> !migraphx.shaped<1x36x384x64xf16, 884736x24576x64x1> attributes{rock.kernel, rock.arch = "gfx908"} {
  ...
  // CHECK: tosa.log
  func.func @func_log_f32(%arg0: !migraphx.shaped<1x36x384x64xf32, 884736x24576x64x1>) -> !migraphx.shaped<1x36x384x64xf32, 884736x24576x64x1> attributes{rock.kernel, rock.arch = "gfx908"} {
  ...
  // CHECK: tosa.log
  func.func @func_log_f16(%arg0: !migraphx.shaped<1x36x384x64xf16, 884736x24576x64x1>) -> !migraphx.shaped<1x36x384x64xf16, 884736x24576x64x1> attributes{rock.kernel, rock.arch = "gfx908"} {
  ...
  // CHECK: tosa.negate
  func.func @func_neg_f32(%arg0: !migraphx.shaped<1x36x384x64xf32, 884736x24576x64x1>) -> !migraphx.shaped<1x36x384x64xf32, 884736x24576x64x1> attributes{rock.kernel, rock.arch = "gfx908"} {
  ...
  // CHECK: tosa.negate
  func.func @func_neg_f16(%arg0: !migraphx.shaped<1x36x384x64xf16, 884736x24576x64x1>) -> !migraphx.shaped<1x36x384x64xf16, 884736x24576x64x1> attributes{rock.kernel, rock.arch = "gfx908"} {
