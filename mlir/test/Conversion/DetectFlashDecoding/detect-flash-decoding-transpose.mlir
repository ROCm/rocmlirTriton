...
#map8 = affine_map<(d0) -> (0, d0 floordiv 65536, (d0 floordiv 256) mod 256, d0 mod 256)>
#map9 = affine_map<(d0, d1, d2) -> ((d0 * 256 + d1) * 128 + d2)>
#map11 = affine_map<(d0, d1, d2, d3, d4) -> (d1 * 2 + d2, d3)>
#map12 = affine_map<(d0) -> (0, d0 floordiv 512, (d0 floordiv 256) mod 2, d0 mod 256, 0)>
...
module {
  func.func @mlir_attention(%arg0: tensor<786432xf16>, %arg1: tensor<786432xf16>, %arg2: tensor<786432xf16>) -> (tensor<1572864xf16>, tensor<6144xf32>) attributes {rock.arch = "amdgcn-amd-amdhsa:gfx942", rock.kernel = "mixr"} {
