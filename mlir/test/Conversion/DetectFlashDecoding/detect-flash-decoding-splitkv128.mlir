...
module {
  func.func @flash_decode_splitkv128(%arg0: tensor<65536xf16>, %arg1: tensor<65536xf16>, %arg2: tensor<65536xf16>) -> (tensor<8388608xf16>, tensor<131072xf32>) attributes {rock.arch = "amdgcn-amd-amdhsa:gfx942", rock.kernel = "mixr", rock.num_cu = 304 : i64} {
    // Q tensor transforms
    ...
    %10 = tensor.empty() : tensor<1024x128x64xf16>
    %11 = tensor.empty() : tensor<1024x128xf32>

    // CHECK: rock.attention{
    // CHECK-NEXT: qk = %{{.*}} * %{{.*}} : tensor<8x128x64xf16>, tensor<8x64x128xf16>
    // CHECK: softmax(qk) * %{{.*}} : tensor<8x128x64xf16>
    ...
    ^bb0(%arg3: memref<1024x1x64xf16>, %arg4: memref<1x8x1x128x64xf32>):
      ...
      rock.yield %arg3 : memref<1024x1x64xf16>
    }
