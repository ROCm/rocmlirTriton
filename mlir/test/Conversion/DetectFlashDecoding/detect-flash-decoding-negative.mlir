...
module {
  ...
  func.func @no_lse_output(%arg0: tensor<393216xf16>, %arg1: tensor<393216xf16>, %arg2: tensor<393216xf16>) -> tensor<393216xf16> attributes {rock.arch = "amdgcn-amd-amdhsa:gfx942", kernel = "mixr"} {
  ...
  func.func @no_broadcast_pattern(%arg0: tensor<393216xf16>, %arg1: tensor<393216xf16>, %arg2: tensor<393216xf16>) -> (tensor<393216xf16>, tensor<3072xf32>) attributes {rock.arch = "amdgcn-amd-amdhsa:gfx942", kernel = "mixr"} {
    %q = rock.transform %arg0 by #transform_map : tensor<393216xf16> to tensor<12x256x128xf16>
    %k = rock.transform %arg1 by #transform_map1 : tensor<393216xf16> to tensor<12x128x256xf16>
    %v = rock.transform %arg2 by #transform_map2 : tensor<393216xf16> to tensor<12x256x128xf16>
  ...
  func.func @different_dimensions(%arg0: tensor<196608xf16>, %arg1: tensor<196608xf16>, %arg2: tensor<196608xf16>) -> (tensor<196608xf16>, tensor<1536xf32>) attributes {rock.arch = "amdgcn-amd-amdhsa:gfx942", kernel = "mixr"} {
    ...
    } {firstGemmIndices = array<i64: 0>, numHeadsKV = 1 : i32, numHeadsQ = 1 : i32, softmaxType = f32, splitKV = 1 : i32} -> tensor<12x128x128xf16>, tensor<12x128xf32>
  ...
  func.func @mismatched_splitkv(%arg0: tensor<786432xf16>, %arg1: tensor<393216xf16>, %arg2: tensor<393216xf16>) -> (tensor<786432xf16>, tensor<3072xf32>) attributes {rock.arch = "amdgcn-amd-amdhsa:gfx942", kernel = "mixr"} {
