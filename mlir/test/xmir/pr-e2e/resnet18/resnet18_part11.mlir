...
module {
  func.func private @forward__part_11(%arg0: tensor<1x128x28x28xf32>, %arg1: tensor<128x1x1xf32>, %arg2: tensor<1x128x28x28xf32>, %arg3: tensor<128x3x3x128xf32>) -> (tensor<1x128x28x28xf32>) {
    ...
    %9 = tosa.conv2d %1, %arg3, %3, %input_zp, %weight_zp {acc_type = f32, dilation = array<i64: 1, 1>, pad = array<i64: 1, 1, 1, 1>, stride = array<i64: 1, 1>} : (tensor<1x28x28x128xf32>, tensor<128x3x3x128xf32>, tensor<128xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<1x28x28x128xf32>
