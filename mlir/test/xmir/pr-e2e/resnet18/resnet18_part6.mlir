...
module {
  func.func private @forward__part_6(%arg0: tensor<1x256x14x14xf32>, %arg1: tensor<256x1x1xf32>, %arg2: tensor<1x256x14x14xf32>, %arg3: tensor<256x3x3x256xf32>) -> (tensor<1x256x14x14xf32>) {
    ...
    %9 = tosa.conv2d %1, %arg3, %3, %input_zp, %weight_zp {acc_type = f32, dilation = array<i64: 1, 1>, pad = array<i64: 1, 1, 1, 1>, stride = array<i64: 1, 1>} : (tensor<1x14x14x256xf32>, tensor<256x3x3x256xf32>, tensor<256xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<1x14x14x256xf32>
