// RUN: rocmlir-gen -fut forward__part_18 --arch %arch --clone-harness %s | rocmlir-driver -pipeline=highlevel -pipeline highlevel | rocmlir-gen -relDiff_threshold 0.00001 -ph -fut forward__part_18_wrapper --verifier clone - | rocmlir-driver -pipeline full -targets %arch | xmir-runner --shared-libs=%linalg_test_lib_dir/libmlir_rocm_runtime%shlibext,%conv_validation_wrapper_library_dir/libconv-validation-wrappers%shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext,%linalg_test_lib_dir/libmlir_float16_utils%shlibext,%linalg_test_lib_dir/libmlir_c_runner_utils%shlibext,%linalg_test_lib_dir/libmlir_async_runtime%shlibext --entry-point-result=void | FileCheck %s
