...
module {
  func.func private @forward__part_19(%arg0: tensor<1x56x56x64xf32>, %arg1: tensor<1x64x1x1xf32>, %arg2: tensor<64x1x1xf32>, %arg3: tensor<1x64x1x1xf32>, %arg4: tensor<1x64x1x1xf32>, %arg5: tensor<64x3x3x64xf32>) -> (tensor<1x64x56x56xf32>) {
    ...
    %4 = tosa.conv2d %arg0, %arg5, %1, %input_zp, %weight_zp {acc_type = f32, dilation = array<i64: 1, 1>, pad = array<i64: 1, 1, 1, 1>, stride = array<i64: 1, 1>} : (tensor<1x56x56x64xf32>, tensor<64x3x3x64xf32>, tensor<64xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<1x56x56x64xf32>
