// RUN: rocmlir-driver -host-pipeline highlevel -arch %arch %s | rocmlir-gen -ph -print-results -rand_type float -rand 1 -fut resnet50 - | rocmlir-driver -host-pipeline mhal -kernel-pipeline full  -arch %arch | xmir-runner --shared-libs=%linalg_test_lib_dir/libmlir_rocm_runtime%shlibext,%conv_validation_wrapper_library_dir/libconv-validation-wrappers%shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext,%linalg_test_lib_dir/libmlir_float16_utils%shlibext,%linalg_test_lib_dir/libmlir_async_runtime%shlibext,%linalg_test_lib_dir/libmlir_c_runner_utils%shlibext --entry-point-result=void | FileCheck %s
