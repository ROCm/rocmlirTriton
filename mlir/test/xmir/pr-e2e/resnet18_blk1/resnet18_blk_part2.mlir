...
module {
  func.func private @forward__part_2(%arg0: tensor<1x3x224x224xf32>, %arg1: tensor<64x3x7x7xf32>, %arg2: tensor<1x64x1x1xf32>, %arg3: tensor<64x1x1xf32>, %arg4: tensor<1x64x1x1xf32>, %arg5: tensor<1x64x1x1xf32>) -> (tensor<1x112x112x64xf32>) {
    ...
    %6 = tosa.conv2d %1, %2, %3, %input_zp, %weight_zp {acc_type = f32, dilation = array<i64: 1, 1>, pad = array<i64: 3, 2, 3, 2>, stride = array<i64: 2, 2>} : (tensor<1x224x224x3xf32>, tensor<64x7x7x3xf32>, tensor<64xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<1x112x112x64xf32>
