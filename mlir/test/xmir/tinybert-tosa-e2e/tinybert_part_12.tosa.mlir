...
// RUN: rocmlir-gen -fut tinybert_part_12 -arch %arch --clone-harness %s | rocmlir-driver -host-pipeline highlevel -kernel-pipeline highlevel -arch %arch | rocmlir-gen -ph -print-results -rand 1 -rand_type float -fut tinybert_part_12 --verifier clone - | rocmlir-driver -c | rocm-run | FileCheck %s
// CHECK-COUNT-2: [1 1 1]
module {
