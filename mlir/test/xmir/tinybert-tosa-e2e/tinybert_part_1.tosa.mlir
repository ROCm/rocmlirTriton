...
// RUN: rocmlir-gen -fut tinybert_part_1 -arch %arch --clone-harness %s | rocmlir-driver -host-pipeline highlevel -kernel-pipeline highlevel -arch %arch | rocmlir-gen -ph -print-results -rand 1 -rand_type float -fut tinybert_part_1 --verifier clone - | rocmlir-driver -c | mlir-runner --shared-libs=%linalg_test_lib_dir/libmlir_rocm_runtime%shlibext,%conv_validation_wrapper_library_dir/libconv-validation-wrappers%shlibext,%linalg_test_lib_dir/libmlir_runner_utils%shlibext,%linalg_test_lib_dir/libmlir_float16_utils%shlibext,%linalg_test_lib_dir/libmlir_c_runner_utils%shlibext,%linalg_test_lib_dir/libmlir_async_runtime%shlibext --entry-point-result=void | FileCheck %s
// CHECK: [1 1 1]
module {
  func.func @tinybert_part_1(%arg0: tensor<2x2x128x64xf32>, %arg1: tensor<2x2x64x128xf32>, %arg2: tensor<1x1x1x1xf32>, %arg3: tensor<2x1x1x128xf32>) -> (tensor<2x2x128x128xf32>) {
    ...
    %2 = "tosa.matmul"(%1, %0, %_zp, %_zp) {acc_type = f32} : (tensor<4x128x64xf32>, tensor<4x64x128xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<4x128x128xf32>
