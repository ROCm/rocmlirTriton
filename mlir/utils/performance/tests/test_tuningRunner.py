...
from tuningRunner import (  # noqa: E402
    ...
    format_error, get_config_class, get_git_commit_hash, NumaTopology, Operation, NumaNodeLock,
    canonicalize_test_vector, DebugFileWriter, TuningResult, tune_config)
...
class TestTunedConfigsCache:
    ...
    def test_parse_new_format_tsv(self):
        tv = ("-t f32 -out_datatype f32 -transA false -transB false -transO false "
              "-g 1 -m 1024 -n 512 -k 769")
...
_SAMPLE_TEST_VECTORS = {
    "gemm": {
        ...
        "canonical": ("-t f32 -out_datatype f32 -transA false -transB false -transO false "
                      "-g 1 -m 1024 -n 512 -k 769"),
        "idempotent": ("-t f16 -out_datatype f16 -transA false -transB true -transO false "
                       "-g 1 -m 256 -n 128 -k 64"),
    },
    "conv": {
        "conf_class":
...
class TestParseArguments:
    ...
    def test_verify_timeout_defaults_to_constant(self):
        ...
        assert parsed.verify_timeout == tuningRunner.DEFAULT_VERIFY_TIMEOUT_SECONDS
    ...
    def test_verify_timeout_override(self):
        ...
        assert parsed.verify_timeout == 1800
