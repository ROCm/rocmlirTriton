...
cmake .. -G Ninja \
  ...
  -DCMAKE_EXE_LINKER_FLAGS="-fuse-ld=lld -Wl,-Bsymbolic-functions" \
  -DCMAKE_SHARED_LINKER_FLAGS="-fuse-ld=lld -Wl,-Bsymbolic-functions" \
  -DCMAKE_MODULE_LINKER_FLAGS="-fuse-ld=lld -Wl,-Bsymbolic-functions" \
  "$@"
