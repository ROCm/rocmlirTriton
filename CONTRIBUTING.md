...
reviewers and the `/review-rocmlir-triton-pr` auto-review skill
categorize findings against the tiers there.
...
workflow above (`git clang-format .`) is the minimum expectation before
opening a PR.
