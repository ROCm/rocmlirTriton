...
module attributes {rock.arch = "amdgcn-amd-amdhsa:gfx1100"} {
  ...
  func.func @main() {
    ...
    %alloc_t1 = memref.alloc() : memref<10000xf16>
    call @_init_buffer(%alloc_t1) : (memref<10000xf16>) -> ()
    %alloc_t1_ref = memref.alloc() : memref<10000xf16>
    memref.copy %alloc_t1, %alloc_t1_ref : memref<10000xf16> to memref<10000xf16>

    %alloc_t2 = memref.alloc() : memref<10000xf16>
    call @_init_buffer(%alloc_t2) : (memref<10000xf16>) -> ()
    %alloc_t2_ref = memref.alloc() : memref<10000xf16>
    memref.copy %alloc_t2, %alloc_t2_ref : memref<10000xf16> to memref<10000xf16>
    ...
    call @rock_gemm_gpu(%alloc_A, %alloc_B, %alloc_t1, %alloc_t2, %alloc_C) : (memref<10000xf16>, memref<10000xf16>, memref<10000xf16>, memref<10000xf16>, memref<10000xf16>) -> ()
    call @host_naive_fused_gemm(%alloc_A_ref, %alloc_B_ref, %alloc_t1_ref, %alloc_t2_ref, %alloc_C_ref) : (memref<10000xf16>, memref<10000xf16>, memref<10000xf16>, memref<10000xf16>, memref<10000xf16>) -> ()
    ...
    memref.dealloc %alloc_t1_ref : memref<10000xf16>
    memref.dealloc %alloc_t2_ref : memref<10000xf16>
    ...
    memref.dealloc %alloc_t1 : memref<10000xf16>
    memref.dealloc %alloc_t2 : memref<10000xf16>
  ...
  // CPU reference: C = (A + (t1 + t2)) * B + (t1 + t2)
  func.func @host_naive_fused_gemm(%arg0: memref<10000xf16>, %arg1: memref<10000xf16>, %arg2: memref<10000xf16>, %arg3: memref<10000xf16>, %arg4: memref<10000xf16>) {
    ...
    %t1_f32 = memref.alloc() : memref<10000xf32>
    call @_memcpy_f16_f32_10000(%arg2, %t1_f32) : (memref<10000xf16>, memref<10000xf32>) -> ()
    %t2_f32 = memref.alloc() : memref<10000xf32>
    call @_memcpy_f16_f32_10000(%arg3, %t2_f32) : (memref<10000xf16>, memref<10000xf32>) -> ()
    %C_f32 = memref.alloc() : memref<10000xf32>

    // Input fusion: A' = A + (t1 + t2), elementwise on flat buffers
    %c0 = arith.constant 0 : index
    %c1 = arith.constant 1 : index
    %c10000 = arith.constant 10000 : index
    scf.for %i = %c0 to %c10000 step %c1 {
      %a_val = memref.load %A_f32[%i] : memref<10000xf32>
      %t1_val = memref.load %t1_f32[%i] : memref<10000xf32>
      %t2_val = memref.load %t2_f32[%i] : memref<10000xf32>
      %sum = arith.addf %t1_val, %t2_val : f32
      %a_fused = arith.addf %a_val, %sum : f32
    ...
    // Output fusion: C = C + (t1 + t2), elementwise on flat buffers
    scf.for %i = %c0 to %c10000 step %c1 {
      %c_val = memref.load %C_f32[%i] : memref<10000xf32>
      %t1_val = memref.load %t1_f32[%i] : memref<10000xf32>
      %t2_val = memref.load %t2_f32[%i] : memref<10000xf32>
      %sum = arith.addf %t1_val, %t2_val : f32
      %c_fused = arith.addf %c_val, %sum : f32
    ...
    memref.dealloc %t1_f32 : memref<10000xf32>
    memref.dealloc %t2_f32 : memref<10000xf32>
  ...
  func.func @rock_gemm_gpu(%arg0: memref<10000xf16>, %arg1: memref<10000xf16>, %arg2: memref<10000xf16>, %arg3: memref<10000xf16>, %arg4: memref<10000xf16>) {
    ...
    %memref_t1 = gpu.alloc  () : memref<10000xf16>
    gpu.memcpy  %memref_t1, %arg2 : memref<10000xf16>, memref<10000xf16>
    %memref_t2 = gpu.alloc  () : memref<10000xf16>
    gpu.memcpy  %memref_t2, %arg3 : memref<10000xf16>, memref<10000xf16>
    ...
    %2 = bufferization.to_tensor %memref_t1 restrict writable : memref<10000xf16> to tensor<10000xf16>
    %3 = bufferization.to_tensor %memref_t2 restrict writable : memref<10000xf16> to tensor<10000xf16>
    ...
    gpu.memcpy  %arg2, %memref_t1 : memref<10000xf16>, memref<10000xf16>
    gpu.dealloc  %memref_t1 : memref<10000xf16>
    gpu.memcpy  %arg3, %memref_t2 : memref<10000xf16>, memref<10000xf16>
    gpu.dealloc  %memref_t2 : memref<10000xf16>
